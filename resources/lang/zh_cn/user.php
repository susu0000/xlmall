...
$_LANG['account_add_error'] = '添加失败';
$_LANG['account_back_list'] = '返回列表';
...
$_LANG['user_bonus'] = '用户优惠券';
$_LANG['user_bonus_info'] = '共计 %d 个,价值 %s';
$_LANG['not_bonus'] = '没有优惠券';
$_LANG['add_user_bonus'] = '添加一个优惠券';
$_LANG['bonus_number'] = '优惠券序列号';
$_LANG['old_password'] = '原密码';
$_LANG['new_password'] = '新密码';
$_LANG['confirm_password'] = '确认密码';
$_LANG['retrieve_password'] = '继续找回密码';
$_LANG['verification_code'] = '验证码错误';
$_LANG['back_login'] = '返回登录页面';
...
$_LANG['log_user'] = '用户登录';
$_LANG['log_mobile'] = '手机号不存在。';
$_LANG['log_pwd_notnull'] = '密码不能为空';
$_LANG['log_opration_error'] = '操作有误';

$_LANG['bonus_sn_exist'] = '此优惠券号码已经被占用了！';
$_LANG['bonus_sn_not_exist'] = '此优惠券号码不存在！';
...
//JS语言项
$_LANG['profile_js']['bonus_sn_empty'] = '请输入您要添加的优惠券号码！';
$_LANG['profile_js']['bonus_sn_error'] = '您输入的优惠券号码格式不正确！';
...
$_LANG['both_password_error'] = '您输入的密码不一致！';
$_LANG['first_password_error'] = '原密码不正确！';
...
/* 会员红包 */
$_LANG['bonus_is_used'] = '你输入的优惠券你已经领取过了！';
$_LANG['bonus_is_used_by_other'] = '你输入的优惠券已经被其他人领取！';
$_LANG['bonus_add_success'] = '您已经成功的添加了一个新的优惠券！';
$_LANG['bonus_not_exist'] = '你输入的优惠券不存在';
$_LANG['user_bonus_empty'] = '您现在还没有优惠券';
$_LANG['add_bonus_sucess'] = '添加新的优惠券操作成功！';
$_LANG['add_bonus_false'] = '添加新的优惠券操作失败！';
$_LANG['bonus_add_expire'] = '该优惠券已经过期！';
...
$_LANG['presale_tip_2'] = '超出尾款支付时间 %s';
...
$_LANG['merge'] = '合并';
$_LANG['notice_order_sn'] = '当两个订单不一致时，合并后的订单信息（如：支付方式、配送方式、包装、贺卡、优惠券等）以第二个为准。';
$_LANG['subtotal'] = '小计';
...
$_LANG['user_auth_code'] = '您的验证码是：';
$_LANG['msg_prompt'] = ',请不要把验证码泄露给其他人，如非本人操作，可不用理会';
...
$_LANG['add_to_attention'] = '确定将此商品加入关注么？';
...
$_LANG['email_nomatch'] = '邮箱不匹配';
$_LANG['forget_mobile_check'] = '用户名手机号不匹配';

$_LANG['msg_input_mobile'] = '请输入手机号';
$_LANG['msg_mobile_exist'] = '该手机号已存在';


/* 活动 activity */
$_LANG['act_index'] = '活动首页';

/*         admin */
$_LANG['request_url_error'] = '请求地址出错';
$_LANG['parameter_error'] = 'callback参数不合法';

/* 文章  article */
$_LANG['article_channel'] = '文章频道';

/* 竞拍 auction  */
$_LANG['auction_action'] = '拍卖活动';

/* 基础类  base  */
$_LANG['error_information'] = '错误信息';
$_LANG['prompt_information'] = '提示信息';
...
/*  购物车  cart */
$_LANG['beyond_limit'] = '已达到数量限制';
$_LANG['prince_not_enough'] = '购物车总价格没达到标准，无法参与活动';
$_LANG['in_shopping_cart'] = '已加入购物车';
$_LANG['cannot_buy'] = '商品您已购买过，无法再购买';
...
$_LANG['group_post'] = '圈子帖';
$_LANG['sunny_post'] = '晒单贴';
...
$_LANG['crowd_order'] = '微筹订单';
$_LANG['crowd_order_detail'] = '订单详情';
$_LANG['crowd_buy'] = '我的支持';
$_LANG['crowd_focus'] = '我的关注';
$_LANG['crowd_comment'] = '商品评论';
