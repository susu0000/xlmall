...
class aliforex
{
    ...
    public function get_code($order, $payment)
    {
        ...
        /* 生成支付按钮 */
        $button = '<script type="text/javascript" src="'.base_url('resources/assets').'/js/ap.js"></script><div><button type="button" class="btn btn-default" onclick="javascript:_AP.pay(\'' . $gateway . $param . '&sign=' . md5($sign) . '\')"  >' . L('pay_button') . '</button></div>';
        return $button;
    }
