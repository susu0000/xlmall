var confirm_cancel = function(content, url)
{
			var obj = '#box';
			var $obj = $('#box');
			$('body').append('<div class="modal-backdrop fade in"></div>').append('	<div id="box" class="my-modal" style="display: block;"><div class="my-modal-content">' + content.trim() + '</div><div class="my-modal-footer"> <a href="javascript:void(0);" class="my-modal-btn my-modal-no">取消</a><a href="javascript:void(0);" class="my-modal-btn my-modal-yes">确定</a></div></div>');

			$(obj).find('a.my-modal-no').on('click', function(){
				$(obj).remove();
			...
			$(obj).find('a.my-modal-yes').on('click', function(){
				$(obj).remove();
				$('div.modal-backdrop').remove();
				if( url.trim() )
				{
...
var my_alert = function(content)
{
	        var obj = '#box';
			var $obj = $('#box');
			$('body').append('<div class="modal-backdrop fade in"></div>').append('	<div id="box" class="my-modal" style="display: block;"><div class="my-modal-content">' + content.trim() + '</div><div class="my-modal-footer"> <a href="javascript:void(0);" class="my-modal-btn my-modal-yes">确定</a></div></div>');
...
function addToCartResponse(e) {
    if (e.error > 0) 2 == e.error ? layer.open({
        ...
        shadeClose: !1,
        yes: function() {
            location.href = ROOT_URL + "index.php?m=user&a=add_booking&id=" + e.goods_id + "&spec=" + e.product_spec
        },
        no: function() {}
    }) : 6 == e.error ? location.href = ROOT_URL + "index.php?m=goods&id=" + e.goods_id: d_messages(e.message);
    else {
        if (e.store_id > 0) return void(window.location.href = ROOT_URL + "index.php?m=flow&store_id=" + e.store_id + "&cart_value=" + e.cart_value);
        $(".cart-num").html(e.goods_number);
        var t = ROOT_URL + "index.php?m=cart";
        location.href = t
    }
}
function collect(e) {
    $.get(ROOT_URL + "index.php?m=goods&a=add_collection", {
        id: e
    },
    function(e) {
        collectResponse(e)
...
function gotoPage(e, t, i, n) {
    $.get("index.php?c=comment&act=gotopage", {
        page: e,
        id: t,
        type: i,
        rank: n
...
function newPrice(e) {
    $.get("index.php?c=snatch&a=new_price_list&id=" + e, "",
    function(e) {
        newPriceResponse(e)
    },
    "text")
...
function sendHashMail() {
    $.get("index.php?c=user&a=send_hash_mail", "",
    function(e) {
...
function orderQuery() {
    ...
    t = /^[\.0-9]+/;
    return e.length < 10 || !t.test(e) ? void alert(invalid_order_sn) : void $.get("index.php?c=user&a=order_query&order_sn=s" + e, "",
    function(e) {
...
function display_mode_wholesale(e) {
    function t() {
        document.forms.wholesale_goods.action = "index.php?c=wholesale",
...
function stringxor(e, t) {
    ...
    s = Math.max(e.length, t.length), a = 0; a < s; a++) {
...
function evalscript(e) {
    ...
    for (var t = /<script[^\>]*?src=\"([^\>]*?)\"[^\>]*?(reload=\"1\")?(?:charset=\"([\w\-]+?)\")?><\/script>/gi,
    i = new Array; i = t.exec(e);) appendscript(i[1], "", i[2], i[3]);
    return e
}
function $$(e) {
...
function pmwin(e, t) {
    ...
    if ("open" == e) {
        ...
        t ? pmframe.location = "index.php?c=pm&" + t: pmframe.location = "index.php?c=pm"
    } else if ("close" == e) {
...
function addPackageToCart(e, t, i) {
    ...
    $.post(ROOT_URL + "index.php?m=flow&a=add_package_to_cart", {
...
function addPackageToCartResponse(e) {
    if (e.error > 0) 2 == e.error && layer.open({
        ...
        shadeClose: !1,
        yes: function() {
            window.location.href = ROOT_URL + "index.php?m=user&a=add_booking&id=" + e.package_id
        },
        no: function() {}
    }),
    1 == e.error ? layer.open({
        content: e.message,
        btn: ["去登录", "不登录"],
        shadeClose: !1,
        yes: function() {
...
function openSpeDiv(e, t, i) {
    ...
    for (var o = 0,
    r = document.getElementsByTagName("select"); r[o];) o++;
    ...
    u.style.filter = "alpha(opacity=30)",
    u.style.opacity = "0.40",
...
function submit_div(e, t) {
    ...
    for (var c = 0,
    d = document.getElementsByTagName("select"); d[c];) d[c].style.visibility = "",
    c++
}
function cancel_div() {
    document.body.removeChild(docEle("speDiv")),
    document.body.removeChild(docEle("mask"));
    for (var e = 0,
    t = document.getElementsByTagName("select"); t[e];) t[e].style.visibility = "",
    e++
}
...
function addToCartResponse_quick(e) {
    if (document.removeEventListener("touchmove", handler, !1), e.error > 0) 2 == e.error ? layer.open({
        ...
        shadeClose: !1,
        yes: function() {
            console.log('yes: ' + ROOT_URL + "index.php?m=user&a=add_booking&id=" + e.goods_id + "&spec=" + e.product_spec);
            return false;
            location.href = ROOT_URL + "index.php?m=user&a=add_booking&id=" + e.goods_id + "&spec=" + e.product_spec
        },
        no: function() {}
    }) : 6 == e.error ? location.href = ROOT_URL + "index.php?m=goods&id=" + e.goods_id: d_messages(e.message, 1);
    else if (e.store_id > 0 && (window.location.href = ROOT_URL + "index.php?m=flow&store_id=" + e.store_id + "&cart_value=" + e.cart_value), d_messages("商品已加入购物", 2), $(".cart-num").html(e.goods_number), $(".j-filter-show-div").hasClass("show")) return $(".j-filter-show-div").removeClass("show"),
...
function in_addToCart(e, t) {
    ...
    i.parent = "undefined" == typeof t ? 0 : parseInt(t),
    $.ajax({
        url: ROOT_URL + "index.php?m=cart&a=add_to_cart",
        type: "POST",
        data: {
            goods: $.toJSON(i)
        },
...
function addtocart_attr(e) {
    ...
    $.ajax({
        ...
        success: function(e) {
            0 == e.error ? d_messages("已加入购物车", 2) : d_messages(e.message, 2),
            window.location = ROOT_URL + "index.php?m=cart"
        }
    })
}
...
function selectShipping(e) {
    if (selectedShipping != e) {
        selectedShipping = e;
        var t = e.attributes.supportCod.value + 0,
        n = e.form;
        for (i = 0; i < n.elements.length; i++)"payment" == n.elements[i].name && "1" == n.elements[i].attributes.isCod.value && (0 == t ? (n.elements[i].checked = !1, n.elements[i].disabled = !0) : n.elements[i].disabled = !1);
        new Date;
        $.get("index-test.php?r=flow/ajax/selectshipping", {
            shipping: e.value
        },
        function(e) {
            orderShippingSelectedResponse(e)
        },
        "json")
    }
}
function orderShippingSelectedResponse(e) {
    if (e.need_insure) try {
        document.getElementById("ECS_NEEDINSURE").checked = !0
    } catch(t) {
        alert(t.message)
    }
    try {
        void 0 != document.getElementById("ECS_CODFEE") && (document.getElementById("ECS_CODFEE").innerHTML = e.cod_fee)
    } catch(t) {
        alert(t.message)
    }
    orderSelectedResponse(e)
}
function selectPayment(e) {
    if (selectedPayment != e) {
        selectedPayment = e;
        for (var t = $("form#theForm input[name='shipping[]']"), i = $("form#theForm input[name='ru_id[]']"), n = [], s = 0; s < t.length; s++) {
            var a = [];
            a.push(i[s].value),
            a.push(t[s].value),
            n[s] = a
        }
        $.get(ROOT_URL + "index.php?m=flow&a=select_payment", {
            payment: e,
            shipping_id: n
        },
        function(e) {
...
function changePayment(e) {
    if (selectedPayment != e) {
        selectedPayment = e;
        var t = e.attributes.order_sn.value,
        i = e.value;
        $.post("index-test.php?r=flow/ajax/gettotal", {
            payment_id: i,
            order_sn: t
        },
        function(e) {
            e ? document.getElementById("order_amount").innerHTML = e: d_messages("请重新选择")
        })
    }
}
function handleGroupBuyShipping(e) {
    if (groupBuyShipping != e) {
        groupBuyShipping = e;
        var t = e.attributes.supportCod.value + 0,
        n = e.form;
        for (i = 0; i < n.elements.length; i++)"payment" == n.elements[i].name && "1" == n.elements[i].attributes.isCod.value && (0 == t ? (n.elements[i].checked = !1, n.elements[i].disabled = !0) : n.elements[i].disabled = !1);
        e.attributes.insure.value + 0 == 0 ? (document.getElementById("ECS_NEEDINSURE").checked = !1, document.getElementById("ECS_NEEDINSURE").disabled = !0) : (document.getElementById("ECS_NEEDINSURE").checked = !1, document.getElementById("ECS_NEEDINSURE").disabled = !1),
        $.get("index.php?m=default&c=group_buy&a=select_shipping", {
            shipping: e.value
        },
        function(e) {
            orderSelectedResponse(e)
...
function handleGroupBuyPayment(e) {
    groupBuyPayment != e && (groupBuyPayment = e, $.get("index.php?m=default&c=group_buy&a=select_payment", {
        payment: e.value
    },
    function(e) {
        orderSelectedResponse(e)
...
function selectPack(e) {
    selectedPack != e && (selectedPack = e, $.get(ROOT_URL + "index.php?m=flow&a=select_pack", {
        pack: e
    },
    function(e) {
        orderSelectedResponse(e)
...
function selectCard(e) {
    selectedCard != e && (selectedCard = e, $.get("index-test.php?r=flow/ajax/selectcard", {
        card: e.value
    },
    function(e) {
        orderSelectedResponse(e)
...
function selectInsure(e) {
    e = e ? 1 : 0,
    $.get("index-test.php?r=flow/ajax/selectinsure", {
        insure: e
    },
    function(e) {
        orderSelectedResponse(e)
...
function handleGroupBuyInsure(e) {
    e = e ? 1 : 0,
    $.get("index.php?m=default&c=group_buy&a=select_insure", {
        insure: e
    },
    function(e) {
        orderSelectedResponse(e)
...
function orderSelectedResponse(e) {
    e.error && (d_messages(e.error), location.href = "./");
    try {
        var t = document.getElementById("ECS_ORDERTOTAL");
        if (t.innerHTML = "object" == typeof e ? e.content: e, void 0 != e.payment) {
            var i = document.forms.theForm.elements.surplus;
            if (void 0 != i && (i.disabled = "balance" == e.pay_code), $("#payment_info").length > 0) {
                if (n = "", e.pay_fee > 0) var n = "<em class='t-remark'>[手续费]</em></span><em class='t-first'>" + e.format_pay_fee + "</em>";
                var s = "<span>" + e.pay_name + n + "<span>";
                $("#payment_info").html(s),
                $(".j-filter-show-div").hasClass("show") && (document.removeEventListener("touchmove", handler, !1), $(".j-filter-show-div").removeClass("show"), $(".mask-filter-div").removeClass("show"))
            }
            $("input[name=payment]").val(e.pay_id)
        }
        void 0 != e.pack_id && $("input[name=pack]").val(e.pack_id),
        void 0 != e.amount && $("#amount").html(e.amount)
    } catch(a) {}
}
function changeSurplus(e) {
    selectedSurplus != e && (selectedSurplus = e, $.get("index-test.php?r=flow/ajax/changesurplus", {
        surplus: e
    },
    function(e) {
        changeSurplusResponse(e)
    },
    "json"))
}
function changeSurplusResponse(e) {
    if (e.error) try {
        document.getElementById("ECS_SURPLUS_NOTICE").innerHTML = e.error,
        ...
        orderSelectedResponse(e.content)
    }
}
function changeIntegral(e) {
    $(".radio-switching").hasClass("active") && (e = 0);
    for (var t = $("form#theForm input[name='shipping[]']"), i = $("form#theForm input[name='ru_id[]']"), n = [], s = 0; s < t.length; s++) {
        var a = [];
        a.push(i[s].value),
        a.push(t[s].value),
    ...
    $.get(ROOT_URL + "index.php?m=flow&a=change_integral", {
        points: e,
        shipping_id: n
    },
    function(e) {
        changeIntegralResponse(e)
    },
    "json")
}
function changeIntegralResponse(e) {
    if (e.error) try {
        d_messages(e.error),
        document.getElementById("ECS_INTEGRAL").value = "0"
    } catch(t) {} else {
        try {
            $(".radio-switching").hasClass("active") ? ($(".radio-switching").removeClass("active"), $("#ECS_INTEGRAL").val(0)) : ($(".radio-switching").addClass("active"), $("#ECS_INTEGRAL").val(e.integral))
        } catch(t) {}
        orderSelectedResponse(e)
    }
}
function changeBonus(e) {
    selectedBonus != e && (selectedBonus = e, $.get("index-test.php?r=flow/ajax/changebonus", {
        bonus: e.value
    },
    function(e) {
        changeBonusResponse(e)
    },
    "json"))
}
function changeBonusResponse(e) {
    if (e.error) {
        alert(e.error);
        try {
            document.getElementById("ECS_BONUS").value = "0"
        } catch(t) {}
    } else orderSelectedResponse(e.content)
}
function validateBonus(e) {
    $.get("index-test.php?r=flow/ajax/validatebonus", {
        bonus_sn: e
    },
    function(e) {
        validateBonusResponse(e)
    },
    "json")
}
function validateBonusResponse(e) {
    if (e.error) {
        alert(e.error),
        orderSelectedResponse(e.content);
        try {
...
function changeNeedInv() {
    var e = document.getElementById("ECS_NEEDINV"),
    t = document.getElementById("ECS_INVTYPE"),
    i = document.getElementById("ECS_INVPAYEE"),
    n = document.getElementById("ECS_INVCONTENT"),
    s = e.checked ? 1 : 0,
    a = e.checked && void 0 != t ? t.value: "",
    o = e.checked ? i.value: "",
    r = e.checked ? n.value: "";
    t.disabled = i.disabled = n.disabled = !e.checked,
    null != t && (t.disabled = !e.checked),
    $.get(ROOT_URL + "index.php?m=flow&a=change_needinv", {
        need_inv: s,
        inv_type: encodeURIComponent(a),
        inv_payee: encodeURIComponent(o),
        inv_content: encodeURIComponent(r)
    },
    function(e) {
        orderSelectedResponse(e)
    })
...
function groupBuyChangeNeedInv() {
    var e = document.getElementById("ECS_NEEDINV"),
    t = document.getElementById("ECS_INVPAYEE"),
    i = document.getElementById("ECS_INVCONTENT"),
    n = e.checked ? 1 : 0,
    s = e.checked ? t.value: "",
    a = e.checked ? i.value: "";
    t.disabled = i.disabled = !e.checked,
    $.get("index.php?m=default&c=group_buy&a=change_needinv", {
        need_idv: n,
        payee: s,
        content: a
    },
...
function changeOOS(e) {
    selectedOOS != e && (selectedOOS = e, $.get("index-test.php?r=flow/ajax/changeoos", {
        oos: e.value
    },
    null))
}
function checkOrderForm(e) {
    for (var t = !1,
    i = $("form#theForm input[name='shipping[]']"), n = $("form#theForm input[name='ru_name[]']"), s = 0; s < i.length; s++) if (0 == i[s].value) {
        var a = n[s].value + "暂不支持该地区配送";
        return d_messages(a),
        !1
    }
    for (s = 0; s < e.elements.length; s++)"payment" == e.elements[s].name && e.elements[s].value > 0 && (t = !0);
    if (!t) return d_messages("请选择支付方式"),
    !1;
    var o = "",
    r = "";
    if (document.getElementById("ECS_SURPLUS")) {
        var l = document.getElementById("ECS_SURPLUS").value;
        $.ajax({
        ...
        if (o) {
            try {
                document.getElementById("ECS_SURPLUS_NOTICE").innerHTML = o
            } catch(c) {}
            return ! 1
        }
    }
    if (document.getElementById("ECS_INTEGRAL")) {
        var d = document.getElementById("ECS_INTEGRAL").value;
        $.ajax({
    ...
    return $("a.btn-submit").attr("disabled", !0),
    setTimeout(function() {
        $("a.btn-submit").attr("disabled", !1)
    },
    5e3),
    !0
}
function checkConsignee(e) {
    var t = new Array,
    i = !1;
    return e.elements.country && 0 == e.elements.country.value && e.elements.country.length > 1 && (i = !0, t.push(country_not_null)),
    e.elements.province && 0 == e.elements.province.value && e.elements.province.length > 1 && (i = !0, t.push(province_not_null)),
    e.elements.city && 0 == e.elements.city.value && e.elements.city.length > 1 && (i = !0, t.push(city_not_null)),
    e.elements.district && e.elements.district.length > 1 && 0 == e.elements.district.value && (i = !0, t.push(district_not_null)),
    Utils.isEmpty(e.elements.consignee.value) && (i = !0, t.push(consignee_not_null)),
    e.elements.address && Utils.isEmpty(e.elements.address.value) && (i = !0, t.push(address_not_null)),
    Utils.isEmpty(e.elements.mobile.value) ? (i = !0, t.push(mobile_not_null)) : Utils.isTel(e.elements.mobile.value) || (i = !0, t.push(mobile_invaild)),
    i && (message = t.join("\n"), alert(message)),
    !i
}
function selectAddress(e) {
    selectedAddress != e && (selectedAddress = e, $.get("index-test.php?r=flow/ajax/selectaddress", {
        address: e.value
    },
    function(e) {
        orderSelectedResponse(e)
...
function warehouse(e, t) {
    if (e && t) {
        var i = ROOT_URL + "index.php?m=goods&a=in_warehouse";
        $.get(i, {
            pid: e,
            id: t
        },
...
function showregionname() {
    ...
    $.post(ROOT_URL + "index.php?m=user&a=show_region_name", {
        province: e,
        city: t,
        district: i
    },
...
function register_sms() {
    var e = $("#mobile_phone").val();
    $("input[name=mobile_code").val();
    return "" == e.length ? (alert("请填写手机号码"), !1) : "" == sms_ccode.length ? (alert("请填写手机验证码"), !1) : void $.post(ROOT_URL + "index.php?m=user&a=register_sms", {
        mobile: e,
        sms_code: code
    },
    function(e) {
...
function sendSms() {
    var e = $("#mobile_phone").val(),
    t = ($("#flag").val(), $("#sms_code").val());
    return "" == e.length ? (alert("请填写手机号码"), !1) : (RemainTime(), void $.post(ROOT_URL + "index.php?m=sms&a=send", {
        mobile: e,
        sms_code: t
    },
    function(e) {
        2 == e.code ? alert("验证码已成功发送到您的手机") : e.msg ? alert(e.msg) : alert("手机验证码发送失败")
    },
    "json"))
}
function register2() {
    ...
    t = $("#mobile_phone").val(),
    i = $("#mobile_code").val();
    return "" == t.length ? (alert("请填写手机号码"), !1) : "" == i.length ? (alert("请填写手机验证码"), !1) : ($.ajax({
        type: "POST",
        url: "index-test.php?r=sms/index/check",
        data: "mobile=" + t + "&mobile_code=" + i + "&flag=register",
        dataType: "json",
        async: !1,
        success: function(t) {
            2 != t.code && (alert(t.msg), e = !1)
        }
    }), e)
}
...
function RemainTime() {
    document.getElementById("zphone").disabled = !0;
    var e, t = "",
    i = "";
    iTime >= 0 ? (e = parseInt(iTime % 60), e >= 0 && (t = e + "秒"), i = t, 0 == iTime ? (clearTimeout(Account), i = "获取手机验证码", iTime = 59, document.getElementById("zphone").disabled = !1) : (Account = setTimeout("RemainTime()", 1e3), iTime -= 1)) : i = "没有倒计时",
    document.getElementById("zphone").innerHTML = i
}
...
function getAddress() {
    function e(e, t, i, s, a, o, r) {
        var l, r = r || null,
        o = o || ["parent_id=1", "parent_id=", "parent_id=", "parent_id=", "parent_id="],
        c = document.getElementById(t),
        e = document.getElementById(e),
        i = document.getElementById(i),
        d = ROOT_URL + "index.php?m=region&a=address&",
        u = [{
            name: "",
            id: "",
            liIndex: 0
        ...
        h = 0,
        p = c.querySelector("#headAddressUl"),
        f = p.children,
        m = c.querySelector("#addressContentDiv"),
        g = m.children,
        v = "",
        s = document.getElementById(s),
        y = (document.getElementById("addressContainer"), document.querySelector(".head-fix"), document.querySelector("#goBack"), !0),
        b = 0,
        w = function(e, t) {
            var i = "";
            if (l = g[0].offsetWidth, t && (f[parseInt(t) - 1].innerHTML = u[parseInt(t) - 1].name), e.addressList.length) {
                f[t].innerHTML = "请选择";
                for (var s = 0; s < 5; s++) f[s].classList.remove("head-address-li");
                f[t].classList.add("head-address-li");
                for (var s = 0; s < e.addressList.length; s++) i += "<li dataId=" + e.addressList[s].id + " liIndex=" + (s + 1) + ">" + e.addressList[s].name + "</li>";
                g[t].innerHTML = i,
                m.style.transform = "translate(" + -l * t + "px,0px) translateZ(0px)",
                m.style.WebkitTransform = "translate(" + -l * t + "px,0px) translateZ(0px)"
            } else {
                for (var s = parseInt(t); s < 5; s++) u[s].name = "",
                u[s].id = 0;
                v = u[0].name.trim() + u[1].name.trim() + u[2].name.trim() + u[3].name.trim() + u[4].name.trim();
                for (var s = 0; s < 5; s++) n.address[s].name = u[s].name.trim(),
                n.address[s].id = u[s].id;
                f[t - 1].innerHTML = "请选择",
        ...
        _ = function(e, t) {
            ...
            var s = 0;
            t && (f[parseInt(t) - 1].innerHTML = n.address[parseInt(t) - 1].name),
            f[t].innerHTML = "请选择";
            for (var a = 0; a < 5; a++) f[a].classList.remove("head-address-li");
            f[t].classList.add("head-address-li");
            for (var a = 0; a < e.addressList.length; a++) i += "<li dataId=" + e.addressList[a].id + " liIndex=" + (a + 1) + ">" + e.addressList[a].name + "</li>",
            e.addressList[a].id == n.address[t].id && (s = a + 1);
            g[t].innerHTML = i,
            g[t].children[parseInt(s - 1)].classList.add("checked-color"),
            g[t].children[parseInt(s - 1)].innerHTML = g[t].children[parseInt(s - 1)].innerHTML + '<span class="check-pic"></span>',
            u[t].liIndex = s,
            b++
        },
        x = function(e, t) {
        ...
        C = function() {
            function t() {
                for (var e = 0; e < 5; e++) u[e].id = n.address[e].id,
                u[e].name = n.address[e].name;
                m.style.transform = "translate(" + -l * (b - 1) + "px,0px) translateZ(0px)",
                m.style.WebkitTransform = "translate(" + -l * (b - 1) + "px,0px) translateZ(0px)",
                y = !0,
                c.style.display = "block"
            }
            h || n.address[0].name ? !h && n.address[0].name ? (y = !1, b = 0, x(d + o[0],
            function() {
                e.style.display = "none",
                n.address[3].name ? x(d + o[1] + n.address[0].id,
                function() {
                    x(d + o[2] + n.address[1].id,
                    function() {
                        x(d + o[3] + n.address[2].id,
                        function() {
                            x(d + o[4] + n.address[3].id, t)
                        })
                    })
                }) : n.address[3].name ? x(d + o[1] + n.address[0].id,
                function() {
                    x(d + o[2] + n.address[1].id,
                    function() {
                        x(d + o[3] + n.address[2].id, t)
                    })
                }) : n.address[2].name ? x(d + o[1] + n.address[0].id,
                function() {
                    x(d + o[2] + n.address[1].id, t)
                }) : n.address[1].name && x(d + o[1] + n.address[0].id, t)
            })) : (e.style.display = "none", c.style.display = "block") : (e.style.display = "none", x(d + o[0]), c.style.display = "block"),
            setTimeout(function() {
                m.style.height = document.documentElement.clientHeight - 89 + "px"
            },
            600);
            for (var i = 0; i < 5; i++) !
            function(e) {
                g[e].onclick = function(t) {
                    var i = t || event,
                    s = i.srcElement || i.target;
                    if (s.getAttribute("liindex")) if (s.className.indexOf("check-pic") != -1 && (s = s.parentNode), parseInt(u[e].liIndex) && this.children[parseInt(u[e].liIndex) - 1] && this.children[parseInt(u[e].liIndex) - 1].className.indexOf("checked-color") != -1 && (this.children[parseInt(u[e].liIndex) - 1].classList.remove("checked-color"), this.children[parseInt(u[e].liIndex) - 1].innerHTML = this.children[parseInt(u[e].liIndex) - 1].innerHTML.replace('<span class="check-pic"></span>', "")), s.classList.add("checked-color"), u[e].name = s.innerHTML, s.innerHTML = s.innerHTML + '<span class="check-pic"></span>', u[e].id = s.getAttribute("dataId"), u[e].liIndex = s.getAttribute("liIndex"), h = e + 1, 4 == e) {
                        v = u[0].name.trim() + u[1].name.trim() + u[2].name.trim() + u[3].name.trim() + u[4].name.trim();
                        for (var a = 0; a < 5; a++) n.address[a].name = u[a].name.trim(),
                        n.address[a].id = u[a].id.trim();
                        window.location.hash = "#checkpage"
                    } else x(d + o[h] + u[e].id)
                }
            } (i);
            p.onclick = function(e) {
                ...
                if (parseInt(n.getAttribute("mytitle")) >= 0 && "" != n.innerHTML && "请选择" != n.innerHTML) {
                    t = n.getAttribute("mytitle"),
                    n.innerHTML = "请选择";
                    for (var s = parseInt(t) + 1; s < 5; s++) f[s].innerHTML = "";
                    for (var s = 0; s < 5; s++) f[s].classList.remove("head-address-li");
                    f[t].classList.add("head-address-li"),
                    m.style.transform = "translate(" + -l * t + "px,0px) translateZ(0px)",
                    m.style.WebkitTransform = "translate(" + -l * t + "px,0px) translateZ(0px)"
        ...
        T = function() {
            if (n.reNum++, n.reNum > 1) try {
                var e = localStorage.getItem("reNum");
                localStorage.setItem("reNum", ++e)
            } catch(t) {}
            var i = window.location.hash;
            "#chooseAddressPage" == i ? C() : "" == i ? (k(), "orderForWanshan" == r && setTimeout(function() {
                r = "",
                window.location.hash = "#chooseAddressPage"
            },
            100)) : k()
    ...
    function t(e) {
        var t = n.address && n.address.length > 0 ? n.address[0] : null,
        i = n.address && n.address.length > 1 ? n.address[1] : null,
        s = n.address && n.address.length > 2 ? n.address[2] : null,
        a = n.address && n.address.length > 3 ? n.address[3] : null,
        o = n.address && n.address.length > 4 ? n.address[4] : null,
        r = t && t.id ? t.id: 0,
        l = i && i.id ? i.id: 0,
        c = s && s.id ? s.id: 0,
        d = a && a.id ? a.id: 0,
        u = o && o.id ? o.id: 0;
        if (document.getElementById("province_id").value = r, document.getElementById("city_id").value = l, document.getElementById("district_id").value = c, document.getElementById("town_id").value = d, document.getElementById("village_id").value = u, document.getElementById("goods_id")) {
            if (document.getElementById("user_id")) var h = document.getElementById("user_id").value;
            var p = document.getElementById("goods_id").value,
            f = ROOT_URL + "index.php?m=goods&a=instock";
            $.get(f, {
                id: p,
                province: r,
                city: l,
    ...
    $(function() {
        $("#addressHome").click(function() {
            var e = $("#addressContentDiv .checked-color").length,
            t = $("#headAddressUl li").eq(2).html(),
            i = "addressname.html",
            n = "";
            if (e > 2 && t) {
                for (var s = 0; s < $(".address-ul").length; s++) {
                    var a = $(".address-ul").eq(s).find(".checked-color").attr("dataid");
                    0 == s && a ? n += "#" + a: a && (n += "-" + a)
                }
                i += n
            }
        ...
        $("#addressHome").length > 0 && ($("#addressHome")[0].style.display.indexOf("block") != -1 ? $("#addressContentDiv").css("paddingBottom", "35px") : $("#addressContentDiv").css("paddingBottom", "0px"))
    });
    var i = document.querySelector("#selectAddressBtn");
    i && i.addEventListener("click",
    function() {
        function e() {
            function e(i, n) {
                if (i) {
                    var a = i.querySelectorAll("li");
                    if (a && a.length) for (var o = 0,
                    r = a.length; o < r; o++) !
                    function(i, n) {
                        function o() {
                            switch (n) {
                            case 0:
                                t = "MMyJD_FourthAddProvince";
                                break;
                            case 1:
                                t = "MMyJD_FourthAddCity";
                                break;
                            case 2:
                                t = "MMyJD_FourthAddCounty";
                                break;
                            case 3:
                                t = "MMyJD_FourthAddVillage"
                            }
                            setTimeout(function() {++n <= 5 && e(s[n], n)
                            },
                            300),
                            a[i].onclick = null
                        }
            ...
            var t, n = document.querySelector("#addressContentDiv"),
            s = n.querySelectorAll("ul.address-ul");
            e(s[0], 0),
            clearTimeout(i)
        }
        function t() {
            function e() {
                if (localStorage && localStorage.getItem("reNum")) {
                    ...
                    "#chooseAddressPage" == window.location.hash ? window.history.go( - parseInt(e) + 1) : window.history.go( - parseInt(e))
                }
                t.onclick = null
            }
            var t = document.querySelector(".choose-address-page .jd-index-header-icon-back");
            t.onclick = e,
            clearTimeout(n)
        }
        this.querySelector("#addressLabelId").classList.remove("empty-tip-placeholder");
        var i = setTimeout(e, 300),
        n = setTimeout(t, 500)
    });
    var n = {
        address: [{
    ...
    $("#selectAddressBtn").val("region-data") && (n.address[0].name = $("#provinceNameIgnoreId").val() ? $("#provinceNameIgnoreId").val() : "", n.address[1].name = $("#cityNameIgnoreId").val() ? $("#cityNameIgnoreId").val() : "", n.address[2].name = $("#areaNameIgnoreId").val() ? $("#areaNameIgnoreId").val() : "", n.address[3].name = $("#townNameIngoreId").val() ? $("#townNameIngoreId").val() : "", n.address[4].name = $("#villageNameIngoreId").val() ? $("#villageNameIngoreId").val() : "", n.address[0].id = document.getElementById("province_id").value, n.address[1].id = document.getElementById("city_id").value, n.address[2].id = document.getElementById("district_id").value, n.address[3].id = document.getElementById("town_id").value, n.address[4].id = document.getElementById("village_id").value),
    e("checkPage", "chooseAddressPage", "selectAddressBtn", "addressLabelId", t, null, "$addressFrom")
}
function adv_index() {
    $(window).scrollTop() > 150 ? ($(".goods-fixed").addClass("active"), $(".goods-left-jiat").addClass("active"), $(".goods-header-nav-box").addClass("active")) : ($(".goods-fixed").removeClass("active"), $(".goods-left-jiat").removeClass("active"), $(".goods-header-nav-box").removeClass("active")),
    $(window).scroll(function() {
        $(window).scrollTop() > 0 && ($(".goods-scoll-bg").removeClass("active"), $(".goods-nav").removeClass("active"))
    })
}
if (!
function(e, t) {
...
function(e, t) {
    ...
    function n(e, t, i) {
        ...
        if ("string" == typeof t) {
            if (he.test(t)) return se.filter(t, e, i);
            t = se.filter(t, e)
        }
        return se.grep(e,
        function(e) {
    ...
    function r() { (fe.addEventListener || "load" === event.type || "complete" === fe.readyState) && (o(), se.ready())
    }
    function l(e, t, i) {
    ...
    function C(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            "script" === i && t.text !== e.text ? (b(t).text = e.text, w(t)) : "object" === i ? (t.parentNode && (t.outerHTML = e.outerHTML), ie.html5Clone && e.innerHTML && !se.trim(t.innerHTML) && (t.innerHTML = e.innerHTML)) : "input" === i && Me.test(e.type) ? (t.defaultChecked = t.checked = e.checked, t.value !== e.value && (t.value = e.value)) : "option" === i ? t.defaultSelected = t.selected = e.defaultSelected: ("input" === i || "textarea" === i) && (t.defaultValue = e.defaultValue)
        }
    }
    function k(t, i) {
    ...
    function E(e, t) {
        if (t in e) return t;
        for (var i = t.charAt(0).toUpperCase() + t.slice(1), n = t, s = ht.length; s--;) if (t = ht[s] + i, t in e) return t;
        return n
    }
    function D(e, t) {
        for (var i, n, s, a = [], o = 0, r = e.length; r > o; o++) n = e[o],
        n.style && (a[o] = se._data(n, "olddisplay"), i = n.style.display, t ? (a[o] || "none" !== i || (n.style.display = ""), "" === n.style.display && De(n) && (a[o] = se._data(n, "olddisplay", T(n.nodeName)))) : (s = De(n), (i && "none" !== i || !s) && se._data(n, "olddisplay", s ? i: se.css(n, "display"))));
        for (o = 0; r > o; o++) n = e[o],
    ...
    function M(e, t, i, n, s) {
        for (var a = i === (n ? "border": "content") ? 4 : "width" === t ? 1 : 0, o = 0; 4 > a; a += 2)"margin" === i && (o += se.css(e, i + Ee[a], !0, s)),
        n ? ("content" === i && (o -= se.css(e, "padding" + Ee[a], !0, s)), "margin" !== i && (o -= se.css(e, "border" + Ee[a] + "Width", !0, s))) : (o += se.css(e, "padding" + Ee[a], !0, s), "padding" !== i && (o += se.css(e, "border" + Ee[a] + "Width", !0, s)));
        return o
    }
    function j(e, t, i) {
        var n = !0,
        ...
        return s + M(e, t, i || (o ? "border": "content"), n, a) + "px"
    }
    ...
    function q(e, t, i, n) {
        ...
        function(t, s) {
            i || Yt.test(e) ? n(e, s) : q(e + "[" + ("object" == typeof s ? t: "") + "]", s, i, n)
        });
    ...
    se.extend = se.fn.extend = function() {
        ...
        r++), "object" == typeof o || se.isFunction(o) || (o = {}), r === l && (o = this, r--); l > r; r++) if (null != (s = arguments[r])) for (n in s) e = o[n],
        i = s[n],
        o !== i && (c && i && (se.isPlainObject(i) || (t = se.isArray(i))) ? (t ? (t = !1, a = e && se.isArray(e) ? e: []) : a = e && se.isPlainObject(e) ? e: {},
        o[n] = se.extend(c, a, i)) : void 0 !== i && (o[n] = i));
        return o
    },
    se.extend({
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (i(Object(e)) ? se.merge(n, "string" == typeof e ? [e] : e) : K.call(n, e)),
            n
        },
    ...
    var ce = function(e) {
        function t(e, t, i, n) {
            var s, a, o, r, l, c, u, p, f, m;
            if ((t ? t.ownerDocument || t: z) !== P && j(t), t = t || P, i = i || [], !e || "string" != typeof e) return i;
            ...
            if (A && !n) {
                ...
                if (_.qsa && (!O || !O.test(e))) {
                    if (p = u = R, f = t, m = 9 === r && e, 1 === r && "object" !== t.nodeName.toLowerCase()) {
        ...
        function p(e, t, i) {
            ...
            function(t, i, a) {
                ...
                if (o) {
                    ...
                    if (l = t[R] || (t[R] = {}), (r = l[n]) && r[0] === B && r[1] === a) return c[2] = r[2];
        ...
        function v(e, t, i, s, a, o) {
            ...
            n(function(n, o, r, l) {
                ...
                b = i ? a || (n ? e: f || s) ? [] : o: y;
                if (i && i(y, b, r, l), s) for (c = g(b, p), s(c, [], r, l), d = c.length; d--;)(u = c[d]) && (b[p[d]] = !(y[p[d]] = u));
                if (n) {
                    if (a || e) {
                        if (a) {
                        ...
                        for (d = b.length; d--;)(u = b[d]) && (c = a ? te.call(n, u) : h[d]) > -1 && (n[c] = !(o[c] = u))
                    }
        ...
        function y(e) {
            for (var t, i, n, s = e.length,
            a = x.relative[e[0].type], o = a || x.relative[" "], r = a ? 1 : 0, l = p(function(e) {
                return e === t
            },
            o, !0), c = p(function(e) {
            ...
            o, !0), d = [function(e, i, n) {
                return ! a && (n || i !== D) || ((t = i).nodeType ? l(e, i, n) : c(e, i, n))
            }]; s > r; r++) if (i = x.relative[e[r].type]) d = [p(f(d), i)];
            else {
                if (i = x.filter[e[r].type].apply(null, e[r].matches), i[R]) {
                    for (n = ++r; s > n && !x.relative[e[n].type]; n++);
                    return v(r > 1 && f(d), r > 1 && h(e.slice(0, r - 1).concat({
                        value: " " === e[r - 2].type ? "*": ""
                    })).replace(le, "$1"), i, n > r && y(e.slice(r, n)), s > n && y(e = e.slice(n)), s > n && h(e))
                }
                d.push(i)
            }
            return f(d)
        ...
        function b(e, i) {
            ...
            o = function(n, o, r, l, c) {
                ...
                _ = b.length;
                for (c && (D = o !== P && o); f !== _ && null != (d = b[f]); f++) {
                    if (a && d) {
                        for (u = 0; h = e[u++];) if (h(d, o, r)) {
                            l.push(d);
                            break
                        }
                        c && (B = w)
        ...
        var w, _, x, C, k, T, S, E, D, I, M, j, P, N, A, O, L, $, H, R = "sizzle" + -new Date,
        z = e.document,
        B = 0,
        W = 0,
        F = i(),
        ...
        try {
            Z.apply(Q = ee.call(z.childNodes), z.childNodes),
        ...
        j = t.setDocument = function(e) {
            ...
            n = i.defaultView;
            return i !== P && 9 === i.nodeType && i.documentElement ? (P = i, N = i.documentElement, A = !k(i), n && n !== n.top && (n.addEventListener ? n.addEventListener("unload",
            function() {
                j()
            },
            ...
            L = [], O = [], (_.qsa = ve.test(i.querySelectorAll)) && (s(function(e) {
                ...
                $.call(e, "[s!='']:x"),
                L.push("!=", re)
            }), O = O.length && new RegExp(O.join("|")), L = L.length && new RegExp(L.join("|")), t = ve.test(N.compareDocumentPosition), H = t || ve.test(N.contains) ?
            function(e, t) {
            ...
            function(e, t) {
                ...
                return n ? n: (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !_.sortDetached && t.compareDocumentPosition(e) === n ? e === i || e.ownerDocument === z && H(z, e) ? -1 : t === i || t.ownerDocument === z && H(z, t) ? 1 : I ? te.call(I, e) - te.call(I, t) : 0 : 4 & n ? -1 : 1)
            }: function(e, t) {
                if (e === t) return M = !0,
                0;
                var n, s = 0,
        ...
        t.matchesSelector = function(e, i) {
            if ((e.ownerDocument || e) !== P && j(e), i = i.replace(ue, "='$1']"), !(!_.matchesSelector || !A || L && L.test(i) || O && O.test(i))) try {
                var n = $.call(e, i);
        ...
        t.attr = function(e, t) { (e.ownerDocument || e) !== P && j(e);
        ...
        t.uniqueSort = function(e) {
            ...
            n = 0,
            s = 0;
            if (M = !_.detectDuplicates, I = !_.sortStable && e.slice(0), e.sort(V), M) {
        ...
        x = t.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, i = !e[6] && e[2];
                    return fe.CHILD.test(e[0]) ? null: (e[3] ? e[2] = e[4] || e[5] || "": i && he.test(i) && (t = T(i, !0)) && (t = i.indexOf(")", i.length - t) - i.length) && (e[0] = e[0].slice(0, t), e[2] = i.slice(0, t)), e.slice(0, 3))
                }
            },
            filter: {
                TAG: function(e) {
                ...
                CLASS: function(e) {
                    var t = F[e + " "];
                    return t || (t = new RegExp("(^|" + ne + ")" + e + "(" + ne + "|$)")) && F(e,
                    function(e) {
                ...
                CHILD: function(e, t, i, n, s) {
                    ...
                    function(e) {
                        ...
                        var c, d, u, h, p, f, m = a !== o ? "nextSibling": "previousSibling",
                        g = t.parentNode,
                        ...
                        if (g) {
                            ...
                            if (f = [o ? g.firstChild: g.lastChild], o && y) {
                                for (d = g[R] || (g[R] = {}), c = d[e] || [], p = c[0] === B && c[1], h = c[0] === B && c[2], u = p && g.childNodes[p]; u = ++p && u && u[m] || (h = p = 0) || f.pop();) if (1 === u.nodeType && ++h && u === t) {
                                    d[e] = [B, p, h];
                                    break
                                }
                            } else if (y && (c = (t[R] || (t[R] = {}))[e]) && c[0] === B) h = c[1];
                            else for (; (u = ++p && u && u[m] || (h = p = 0) || f.pop()) && ((r ? u.nodeName.toLowerCase() !== v: 1 !== u.nodeType) || !++h || (y && ((u[R] || (u[R] = {}))[e] = [B, h]), u !== t)););
                            return h -= s,
                            h === n || h % n === 0 && h / n >= 0
                        }
                    }
                ...
                PSEUDO: function(e, i) {
                    ...
                    return a[R] ? a(i) : a.length > 1 ? (s = [e, e, "", i], x.setFilters.hasOwnProperty(e.toLowerCase()) ? n(function(e, t) {
        ...
        T = t.tokenize = function(e, i) {
            ...
            for (r = e, l = [], c = x.preFilter; r;) { (!n || (s = ce.exec(r))) && (s && (r = r.slice(s[0].length) || r), l.push(a = [])),
                n = !1,
        ...
        E = t.select = function(e, t, i, n) {
            ...
            u = !n && T(e = c.selector || e);
            if (i = i || [], 1 === u.length) {
                if (a = u[0] = u[0].slice(0), a.length > 2 && "ID" === (o = a[0]).type && _.getById && 9 === t.nodeType && A && x.relative[a[1].type]) {
                ...
                for (s = fe.needsContext.test(e) ? 0 : a.length; s--&&(o = a[s], !x.relative[r = o.type]);) if ((l = x.find[r]) && (n = l(o.matches[0].replace(_e, xe), be.test(a[0].type) && d(t.parentNode) || t))) {
                    if (a.splice(s, 1), e = n.length && h(a), !e) return Z.apply(i, n),
                    i;
                    break
                }
            }
            return (c || S(e, u))(n, t, !A, i, be.test(e) && d(t.parentNode) || t),
            i
        },
        _.sortStable = R.split("").sort(V).join("") === R,
    ...
    se.filter = function(e, t, i) {
        var n = t[0];
        return i && (e = ":not(" + e + ")"),
        1 === t.length && 1 === n.nodeType ? se.find.matchesSelector(n, e) ? [n] : [] : se.find.matches(e, se.grep(t,
        function(e) {
            return 1 === e.nodeType
        }))
    },
    ...
    ge = se.fn.init = function(e, t) {
        ...
        if ("string" == typeof e) {
            ...
            if (i[1]) {
                if (t = t instanceof se ? t[0] : t, se.merge(this, se.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t: fe, !0)), ue.test(i[1]) && se.isPlainObject(t)) for (i in t) se.isFunction(this[i]) ? this[i](t[i]) : this.attr(i, t[i]);
                return this
            }
    ...
    se.fn.extend({
        ...
        closest: function(e, t) {
            for (var i, n = 0,
            s = this.length,
            a = [], o = de.test(e) || "string" != typeof e ? se(e, t || this.context) : 0; s > n; n++) for (i = this[n]; i && i !== t; i = i.parentNode) if (i.nodeType < 11 && (o ? o.index(i) > -1 : 1 === i.nodeType && se.find.matchesSelector(i, e))) {
                a.push(i);
                break
            }
    ...
    se.Callbacks = function(e) {
        e = "string" == typeof e ? we[e] || a(e) : se.extend({},
        e);
        var t, i, n, s, o, r, l = [],
        c = !e.once && [],
        d = function(a) {
            ...
            add: function() {
                if (l) {
                    ...
                    function a(t) {
                        ...
                        function(t, i) {
                            var n = se.type(i);
                            "function" === n ? e.unique && u.has(i) || l.push(i) : i && i.length && "string" !== n && a(i)
                        })
                    } (arguments),
    ...
    se.fn.extend({
        ...
        promise: function(e, t) {
            ...
            a = this,
            o = this.length,
            r = function() {--n || s.resolveWith(a, [a])
            };
    ...
    function() {
        ...
        if (t.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", ie.leadingWhitespace = 3 === t.firstChild.nodeType, ie.tbody = !t.getElementsByTagName("tbody").length, ie.htmlSerialize = !!t.getElementsByTagName("link").length, ie.html5Clone = "<:nav></:nav>" !== fe.createElement("nav").cloneNode(!0).outerHTML, e.type = "checkbox", e.checked = !0, i.appendChild(e), ie.appendChecked = e.checked, t.innerHTML = "<textarea>x</textarea>", ie.noCloneChecked = !!t.cloneNode(!0).lastChild.defaultValue, i.appendChild(t), t.innerHTML = "<input type='radio' checked='checked' name='t'/>", ie.checkClone = t.cloneNode(!0).cloneNode(!0).lastChild.checked, ie.noCloneEvent = !0, t.attachEvent && (t.attachEvent("onclick",
        function() {
            ie.noCloneEvent = !1
    ...
    se.event = {
        ...
        add: function(e, t, i, n, s) {
            var a, o, r, l, c, d, u, h, p, f, m, g = se._data(e);
            if (g) {
                ...
                l), (h = o[p]) || (h = o[p] = [], h.delegateCount = 0, c.setup && c.setup.call(e, n, f, d) !== !1 || (e.addEventListener ? e.addEventListener(p, d, !1) : e.attachEvent && e.attachEvent("on" + p, d))), c.add && (c.add.call(e, u), u.handler.guid || (u.handler.guid = i.guid)), s ? h.splice(h.delegateCount++, 0, u) : h.push(u), se.event.global[p] = !0);
                e = null
            }
        },
        remove: function(e, t, i, n, s) {
            var a, o, r, l, c, d, u, h, p, f, m, g = se.hasData(e) && se._data(e);
            if (g && (d = g.events)) {
                for (t = (t || "").match(be) || [""], c = t.length; c--;) if (r = Oe.exec(t[c]) || [], p = m = r[1], f = (r[2] || "").split(".").sort(), p) {
                    for (u = se.event.special[p] || {},
                    p = (n ? u.delegateType: u.bindType) || p, h = d[p] || [], r = r[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = a = h.length; a--;) o = h[a],
                    !s && m !== o.origType || i && i.guid !== o.guid || r && !r.test(o.namespace) || n && n !== o.selector && ("**" !== n || !o.selector) || (h.splice(a, 1), o.selector && h.delegateCount--, u.remove && u.remove.call(e, o));
        ...
        trigger: function(t, i, n, s) {
            ...
            s || !c.trigger || c.trigger.apply(n, i) !== !1)) {
                ...
                if (t.type = p, !s && !t.isDefaultPrevented() && (!c._default || c._default.apply(h.pop(), i) === !1) && se.acceptData(n) && o && n[p] && !se.isWindow(n)) {
                    d = n[o],
                    d && (n[o] = null),
        ...
        fix: function(e) {
            ...
            a = e,
            o = this.fixHooks[s];
            for (o || (this.fixHooks[s] = o = Ne.test(s) ? this.mouseHooks: Pe.test(s) ? this.keyHooks: {}), n = o.props ? this.props.concat(o.props) : this.props, e = new se.Event(a), t = n.length; t--;) i = n[t],
            e[i] = a[i];
    ...
    ie.submitBubbles || (se.event.special.submit = {
        setup: function() {
            return ! se.nodeName(this, "form") && void se.event.add(this, "click._submit keypress._submit",
            function(e) {
                var t = e.target,
    ...
    ie.changeBubbles || (se.event.special.change = {
        setup: function() {
            return je.test(this.nodeName) ? (("checkbox" === this.type || "radio" === this.type) && (se.event.add(this, "propertychange._change",
            function(e) {
            ...
            function(e) {
                var t = e.target;
                je.test(t.nodeName) && !se._data(t, "changeBubbles") && (se.event.add(t, "change._change",
    ...
    Qe = m(fe),
    Ke = Qe.appendChild(fe.createElement("div"));
    ...
    se.extend({
        clone: function(e, t, i) {
            ...
            if (ie.html5Clone || se.isXMLDoc(e) || !He.test("<" + e.nodeName + ">") ? a = e.cloneNode(!0) : (Ke.innerHTML = e.outerHTML, Ke.removeChild(a = Ke.firstChild)), !(ie.noCloneEvent && ie.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || se.isXMLDoc(e))) for (n = g(a), r = g(e), o = 0; null != (s = r[o]); ++o) n[o] && C(s, n[o]);
        ...
        buildFragment: function(e, t, i, n) {
            for (var s, a, o, r, l, c, d, u = e.length,
            h = m(t), p = [], f = 0; u > f; f++) if (a = e[f], a || 0 === a) if ("object" === se.type(a)) se.merge(p, a.nodeType ? [a] : a);
            else if (Fe.test(a)) {
                for (r = r || h.appendChild(t.createElement("div")), l = (Be.exec(a) || ["", ""])[1].toLowerCase(), d = Xe[l] || Xe._default, r.innerHTML = d[1] + a.replace(ze, "<$1></$2>") + d[2], s = d[0]; s--;) r = r.lastChild;
                if (!ie.leadingWhitespace && Re.test(a) && p.push(t.createTextNode(Re.exec(a)[0])), !ie.tbody) for (a = "table" !== l || We.test(a) ? "<table>" !== d[1] || We.test(a) ? 0 : r: r.firstChild, s = a && a.childNodes.length; s--;) se.nodeName(c = a.childNodes[s], "tbody") && !c.childNodes.length && a.removeChild(c);
                for (se.merge(p, r.childNodes), r.textContent = ""; r.firstChild;) r.removeChild(r.firstChild);
                r = h.lastChild
            } else p.push(t.createTextNode(a));
            for (r && h.removeChild(r), ie.appendChecked || se.grep(g(p, "input"), v), f = 0; a = p[f++];) if ((!n || -1 === se.inArray(a, n)) && (o = se.contains(a.ownerDocument, a), r = g(h.appendChild(a), "script"), o && _(r), i)) for (s = 0; a = r[s++];) Ve.test(a.type || "") && i.push(a);
            return r = null,
            h
        },
        cleanData: function(e, t) {
            ...
            l = se.cache,
            c = ie.deleteExpando,
            d = se.event.special; null != (i = e[o]); o++) if ((t || se.acceptData(i)) && (s = i[r], a = s && l[s])) {
    ...
    se.fn.extend({
        ...
        html: function(e) {
            ...
            function(e) {
                ...
                if (! ("string" != typeof e || qe.test(e) || !ie.htmlSerialize && He.test(e) || !ie.leadingWhitespace && Re.test(e) || Xe[(Be.exec(e) || ["", ""])[1].toLowerCase()])) {
                    e = e.replace(ze, "<$1></$2>");
                    try {
                        for (; n > i; i++) t = this[i] || {},
        ...
        domManip: function(e, t) {
            ...
            if (c && (r = se.buildFragment(e, this[0].ownerDocument, !1, this), i = r.firstChild, 1 === r.childNodes.length && (r = i), i)) {
                ...
                l !== u && (n = se.clone(n, !0, !0), s && se.merge(a, g(n, "script"))),
                t.call(this[l], n, l);
                if (s) for (o = a[a.length - 1].ownerDocument, se.map(a, w), l = 0; s > l; l++) n = a[l],
                Ve.test(n.type || "") && !se._data(n, "globalEval") && se.contains(o, n) && (n.src ? se._evalUrl && se._evalUrl(n.src) : se.globalEval((n.text || n.textContent || n.innerHTML || "").replace(Ge, "")));
                r = i = null
            }
            return this
        }
    ...
    function(e, t) {
        se.fn[e] = function(e) {
            for (var i, n = 0,
            s = [], a = se(e), o = a.length - 1; o >= n; n++) i = n === o ? this: this.clone(!0),
            se(a[n])[t](i),
            K.apply(s, i.get());
    ...
    se.extend({
        ...
        style: function(e, t, i, n) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                l = e.style;
                if (t = se.cssProps[r] || (se.cssProps[r] = E(l, r)), o = se.cssHooks[t] || se.cssHooks[r], void 0 === i) return o && "get" in o && void 0 !== (s = o.get(e, !1, n)) ? s: l[t];
        ...
        css: function(e, t, i, n) {
            var s, a, o, r = se.camelCase(t);
            return t = se.cssProps[r] || (se.cssProps[r] = E(e.style, r)),
    ...
    function(e, t) {
        se.cssHooks[t] = {
            get: function(e, i, n) {
                return i ? rt.test(se.css(e, "display")) && 0 === e.offsetWidth ? se.swap(e, dt,
                function() {
                    return j(e, t, n)
                }) : j(e, t, n) : void 0
            },
            set: function(e, i, n) {
                var s = n && et(e);
                return I(e, i, n ? M(e, t, n, ie.boxSizing && "border-box" === se.css(e, "boxSizing", !1, s), s) : 0)
            }
        }
    }),
    ...
    function(e, t) {
        se.cssHooks[e + t] = {
            expand: function(i) {
                for (var n = 0,
                s = {},
                a = "string" == typeof i ? i.split(" ") : [i]; 4 > n; n++) s[e + Ee[n] + t] = a[n] || a[n - 2] || a[0];
                return s
            }
        },
    ...
    se.speed = function(e, t, i) {
        var n = e && "object" == typeof e ? se.extend({},
        e) : {
    ...
    se.fn.extend({
        ...
        animate: function(e, t, i, n) {
            ...
            o = function() {
                ...
                e), a); (s || se._data(this, "finish")) && t.stop(!0)
            };
            return o.finish = o,
        ...
        stop: function(e, t, i) {
            ...
            this.each(function() {
                ...
                for (s = a.length; s--;) a[s].elem !== this || null != e && a[s].queue !== e || (a[s].anim.stop(i), t = !1, a.splice(s, 1)); (t || !i) && se.dequeue(this, e)
            })
        },
        finish: function(e) {
            return e !== !1 && (e = e || "fx"),
    ...
    se.fn.extend({
        val: function(e) {
            ...
            return arguments.length ? (n = se.isFunction(e), this.each(function(i) {
                var s;
                1 === this.nodeType && (s = n ? e.call(this, i, se(this).val()) : e, null == s ? s = "": "number" == typeof s ? s += "": se.isArray(s) && (s = se.map(s,
                function(e) {
                    return null == e ? "": e + ""
        ...
        valHooks: {
            ...
            select: {
                get: function(e) {
                    ...
                    s = e.selectedIndex,
                    a = "select-one" === e.type || 0 > s,
                    o = a ? null: [], r = a ? s + 1 : n.length, l = 0 > s ? r: a ? s: 0; r > l; l++) if (i = n[l], !(!i.selected && l !== s || (ie.optDisabled ? i.disabled: null !== i.getAttribute("disabled")) || i.parentNode.disabled && se.nodeName(i.parentNode, "optgroup"))) {
                ...
                set: function(e, t) {
                    for (var i, n, s = e.options,
                    a = se.makeArray(t), o = s.length; o--;) if (n = s[o], se.inArray(se.valHooks.option.get(n), a) >= 0) try {
                        n.selected = i = !0
                    } catch(r) {
                        n.scrollHeight
                    } else n.selected = !1;
    ...
    se.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            function(i) {
                ...
                s = se(this), a = e.match(be) || []; t = a[n++];) s.hasClass(t) ? s.removeClass(t) : s.addClass(t);
        ...
        hasClass: function(e) {
            for (var t = " " + e + " ",
            i = 0,
            n = this.length; n > i; i++) if (1 === this[i].nodeType && (" " + this[i].className + " ").replace(It, " ").indexOf(t) >= 0) return ! 0;
            return ! 1
        }
    }),
    ...
    se.extend({
        ...
        ajax: function(e, t) {
            function i(e, t, i, n) {
                var s, d, v, y, w, x = t;
                2 !== b && (b = 2, r && clearTimeout(r), c = void 0, o = n || "", _.readyState = e > 0 ? 4 : 0, s = e >= 200 && 300 > e || 304 === e, i && (y = W(u, _, i)), y = F(u, y, _, s), s ? (u.ifModified && (w = _.getResponseHeader("Last-Modified"), w && (se.lastModified[a] = w), w = _.getResponseHeader("etag"), w && (se.etag[a] = w)), 204 === e || "HEAD" === u.type ? x = "nocontent": 304 === e ? x = "notmodified": (x = y.state, d = y.data, v = y.error, s = !v)) : (v = x, (e || !x) && (x = "error", 0 > e && (e = 0))), _.status = e, _.statusText = (t || x) + "", s ? f.resolveWith(h, [d, x, _]) : f.rejectWith(h, [_, x, v]), _.statusCode(g), g = void 0, l && p.trigger(s ? "ajaxSuccess": "ajaxError", [_, u, s ? d: v]), m.fireWith(h, [_, x]), l && (p.trigger("ajaxComplete", [_, u]), --se.active || se.event.trigger("ajaxStop")))
            }
            "object" == typeof e && (t = e, e = void 0),
            t = t || {};
            var n, s, a, o, r, l, c, d, u = se.ajaxSetup({},
            t),
            h = u.context || u,
            ...
            if (f.promise(_).complete = m.add, _.success = _.done, _.error = _.fail, u.url = ((e || u.url || At) + "").replace(Ot, "").replace(zt, Nt[1] + "//"), u.type = t.method || t.type || u.method || u.type, u.dataTypes = se.trim(u.dataType || "*").toLowerCase().match(be) || [""], null == u.crossDomain && (n = Bt.exec(u.url.toLowerCase()), u.crossDomain = !(!n || n[1] === Nt[1] && n[2] === Nt[2] && (n[3] || ("http:" === n[1] ? "80": "443")) === (Nt[3] || ("http:" === Nt[1] ? "80": "443")))), u.data && u.processData && "string" != typeof u.data && (u.data = se.param(u.data, u.traditional)), z(Wt, u, t, _), 2 === b) return _;
            l = u.global,
            l && 0 === se.active++&&se.event.trigger("ajaxStart"),
            u.type = u.type.toUpperCase(),
            u.hasContent = !Rt.test(u.type),
            a = u.url,
            u.hasContent || (u.data && (a = u.url += (jt.test(a) ? "&": "?") + u.data, delete u.data), u.cache === !1 && (u.url = Lt.test(a) ? a.replace(Lt, "$1_=" + Mt++) : a + (jt.test(a) ? "&": "?") + "_=" + Mt++)),
            u.ifModified && (se.lastModified[a] && _.setRequestHeader("If-Modified-Since", se.lastModified[a]), se.etag[a] && _.setRequestHeader("If-None-Match", se.etag[a])),
            (u.data && u.hasContent && u.contentType !== !1 || t.contentType) && _.setRequestHeader("Content-Type", u.contentType),
            _.setRequestHeader("Accept", u.dataTypes[0] && u.accepts[u.dataTypes[0]] ? u.accepts[u.dataTypes[0]] + ("*" !== u.dataTypes[0] ? ", " + qt + "; q=0.01": "") : u.accepts["*"]);
    ...
    se.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !se(this).is(":disabled") && Qt.test(this.nodeName) && !Xt.test(e) && (this.checked || !Me.test(e))
            }).map(function(e, t) {
                var i = se(this).val();
    ...
    e.ActiveXObject && se(e).on("unload",
    function() {
        ...
        if (e.crossDomain) {
            ...
            return {
                send: function(n, s) {
                    ...
                    t.src = e.url,
                    t.onload = t.onreadystatechange = function(e, i) { (i || !t.readyState || /loaded|complete/.test(t.readyState)) && (t.onload = t.onreadystatechange = null, t.parentNode && t.parentNode.removeChild(t), t = null, i || s(200, "success"))
                    },
    ...
    function(t, i, n) {
        ...
        return r || "jsonp" === t.dataTypes[0] ? (s = t.jsonpCallback = se.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, r ? t[r] = t[r].replace(ti, "$1" + s) : t.jsonp !== !1 && (t.url += (jt.test(t.url) ? "&": "?") + t.jsonp + "=" + s), t.converters["script json"] = function() {
    ...
    se.offset = {
        setOffset: function(e, t, i) {
            ...
            c ? (n = u.position(), o = n.top, s = n.left) : (o = parseFloat(a) || 0, s = parseFloat(l) || 0),
    ...
    se.fn.extend({
        offset: function(e) {
            ...
            s = this[0],
            a = s && s.ownerDocument;
            return a ? (t = a.documentElement, se.contains(t, s) ? (typeof s.getBoundingClientRect !== Ce && (n = s.getBoundingClientRect()), i = Y(a), {
    ...
    se.each(["top", "left"],
    function(e, t) {
        se.cssHooks[t] = S(ie.pixelPosition,
        function(e, i) {
    ...
    var t, i = function(e, s) {
        ...
        function d(e) {
            ...
            if (! (e.shiftKey || e.altKey || e.ctrlKey || e.metaKey || document.activeElement && document.activeElement.nodeName && ("input" === document.activeElement.nodeName.toLowerCase() || "textarea" === document.activeElement.nodeName.toLowerCase()))) {
                if (37 === t || 39 === t || 38 === t || 40 === t) {
                    ...
                    for (var l = [[r.left, r.top], [r.left + _.width, r.top], [r.left, r.top + _.height], [r.left + _.width, r.top + _.height]], c = 0; c < l.length; c++) {
                        var d = l[c];
        ...
        _.params.breakpoints && _.setBreakpoint(), _.container = t(e), 0 !== _.container.length)) {
            ...
            _.updateSlidesSize = function() {
                ...
                d = r / c,
                u = d - (_.params.slidesPerColumn * d - _.slides.length);
                for (e = 0; e < _.slides.length; e++) {
                    l = 0;
                    var h = _.slides.eq(e);
                    if (_.params.slidesPerColumn > 1) {
                        var p, f, m;
                        "column" === _.params.slidesPerColumnFill ? (f = Math.floor(e / c), m = e - f * c, (f > u || f === u && m === c - 1) && ++m >= c && (m = 0, f++), p = f + m * r / c, h.css({
                    ...
                    "none" !== h.css("display") && ("auto" === _.params.slidesPerView ? (l = a() ? h.outerWidth(!0) : h.outerHeight(!0), _.params.roundLengths && (l = o(l))) : (l = (_.size - (_.params.slidesPerView - 1) * t) / _.params.slidesPerView, _.params.roundLengths && (l = o(l)), a() ? _.slides[e].style.width = l + "px": _.slides[e].style.height = l + "px"), _.slides[e].swiperSlideSize = l, _.slidesSizesGrid.push(l), _.params.centeredSlides ? (i = i + l / 2 + n / 2 + t, 0 === e && (i = i - _.size / 2 - t), Math.abs(i) < .001 && (i = 0), s % _.params.slidesPerGroup === 0 && _.snapGrid.push(i), _.slidesGrid.push(i)) : (s % _.params.slidesPerGroup === 0 && _.snapGrid.push(i), _.slidesGrid.push(i), i = i + l + t), _.virtualSize += l + t, n = l, s++)
                }
            ...
            _.updateActiveIndex = function() {
                ...
                for (t = 0; t < _.slidesGrid.length; t++)"undefined" != typeof _.slidesGrid[t + 1] ? n >= _.slidesGrid[t] && n < _.slidesGrid[t + 1] - (_.slidesGrid[t + 1] - _.slidesGrid[t]) / 2 ? e = t: n >= _.slidesGrid[t] && n < _.slidesGrid[t + 1] && (e = t + 1) : n >= _.slidesGrid[t] && (e = t); (0 > e || "undefined" == typeof e) && (e = 0),
            ...
            _.updatePagination = function() {
                if (_.params.pagination && _.paginationContainer && _.paginationContainer.length > 0) {
                    for (var e = "",
                    t = _.params.loop ? Math.ceil((_.slides.length - 2 * _.loopedSlides) / _.params.slidesPerGroup) : _.snapGrid.length, i = 0; t > i; i++) e += _.params.paginationBulletRender ? _.params.paginationBulletRender(i, _.params.bulletClass) : "<" + _.params.paginationElement + ' class="' + _.params.bulletClass + '"></' + _.params.paginationElement + ">";
            ...
            var C, k, T, S, E, D, I, M, j, P, N = "input, select, textarea, button",
            A = Date.now(),
            O = [];
            _.animating = !1,
            _.touches = {
                ...
                if (e.originalEvent && (e = e.originalEvent), L = "touchstart" === e.type, L || !("which" in e) || 3 !== e.which) {
                    ...
                    if (!_.params.swipeHandler || l(e, _.params.swipeHandler)) {
                        ...
                        if (! (_.device.ios && _.params.iOSEdgeSwipeDetection && i <= _.params.iOSEdgeSwipeThreshold)) {
                            if (C = !0, k = !1, T = !0, E = void 0, $ = void 0, _.touches.startX = i, _.touches.startY = n, S = Date.now(), _.allowClick = !0, _.updateContainerSize(), _.swipeDirection = void 0, _.params.threshold > 0 && (M = !1), "touchstart" !== e.type) {
                                var s = !0;
                                t(e.target).is(N) && (s = !1),
            ...
            _.onTouchMove = function(e) {
                if (e.originalEvent && (e = e.originalEvent), !(L && "mousemove" === e.type || e.preventedByNestedSwiper)) {
                    ...
                    if (L && document.activeElement && e.target === document.activeElement && t(e.target).is(N)) return k = !0,
                    void(_.allowClick = !1);
                    if (T && _.emit("onTouchMove", _, e), !(e.targetTouches && e.targetTouches.length > 1)) {
                        if (_.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX: e.pageX, _.touches.currentY = "touchmove" === e.type ? e.targetTouches[0].pageY: e.pageY, "undefined" == typeof E) {
                            var i = 180 * Math.atan2(Math.abs(_.touches.currentY - _.touches.startY), Math.abs(_.touches.currentX - _.touches.startX)) / Math.PI;
                            E = a() ? i > _.params.touchAngle: 90 - i > _.params.touchAngle
                        }
                        if (E && _.emit("onTouchMoveOpposite", _, e), "undefined" == typeof $ && _.browser.ieTouch && (_.touches.currentX !== _.touches.startX || _.touches.currentY !== _.touches.startY) && ($ = !0), C) {
                            ...
                            if ($ || !_.browser.ieTouch) {
                                ...
                                D = n + I;
                                var o = !0;
                                if (n > 0 && D > _.minTranslate() ? (o = !1, _.params.resistance && (D = _.minTranslate() - 1 + Math.pow( - _.minTranslate() + I + n, _.params.resistanceRatio))) : 0 > n && D < _.maxTranslate() && (o = !1, _.params.resistance && (D = _.maxTranslate() + 1 - Math.pow(_.maxTranslate() - I - n, _.params.resistanceRatio))), o && (e.preventedByNestedSwiper = !0), !_.params.allowSwipeToNext && "next" === _.swipeDirection && I > D && (D = I), !_.params.allowSwipeToPrev && "prev" === _.swipeDirection && D > I && (D = I), _.params.followFinger) {
                                    if (_.params.threshold > 0) {
                                        if (! (Math.abs(n) > _.params.threshold || M)) return void(D = I);
                                        if (!M) return M = !0,
            ...
            _.onTouchEnd = function(e) {
                if (e.originalEvent && (e = e.originalEvent), T && _.emit("onTouchEnd", _, e), T = !1, C) {
                    ...
                    var i = Date.now(),
                    n = i - S;
                    if (_.allowClick && (_.updateClickedSlide(e), _.emit("onTap", _, e), 300 > n && i - A > 300 && (j && clearTimeout(j), j = setTimeout(function() {
                    ...
                    300)), 300 > n && 300 > i - A && (j && clearTimeout(j), _.emit("onDoubleTap", _, e))), A = Date.now(), setTimeout(function() {
                        _ && (_.allowClick = !0)
                    },
                    0), !C || !k || !_.swipeDirection || 0 === _.touches.diff || D === I) return void(C = k = !1);
                    C = k = !1;
                    var s;
                    if (s = _.params.followFinger ? _.rtl ? _.translate: -_.translate: -D, _.params.freeMode) {
                        ...
                        if (_.params.freeModeMomentum) {
                            ...
                            if (u < _.maxTranslate()) _.params.freeModeMomentumBounce ? (u + _.maxTranslate() < -f && (u = _.maxTranslate() - f), h = _.maxTranslate(), p = !0, P = !0) : u = _.maxTranslate();
                            else if (u > _.minTranslate()) _.params.freeModeMomentumBounce ? (u - _.minTranslate() > f && (u = _.minTranslate() + f), h = _.minTranslate(), p = !0, P = !0) : u = _.minTranslate();
                            else if (_.params.freeModeSticky) {
                                var m, g = 0;
                                for (g = 0; g < _.snapGrid.length; g += 1) if (_.snapGrid[g] > -u) {
                                    m = g;
                                    break
                                }
                                u = Math.abs(_.snapGrid[m] - u) < Math.abs(_.snapGrid[m - 1] - u) || "next" === _.swipeDirection ? _.snapGrid[m] : _.snapGrid[m - 1],
                                _.rtl || (u = -u)
                            }
                            if (0 !== _.velocity) c = _.rtl ? Math.abs(( - u - _.translate) / _.velocity) : Math.abs((u - _.translate) / _.velocity);
                            else if (_.params.freeModeSticky) return void _.slideReset();
                            _.params.freeModeMomentumBounce && p ? (_.updateProgress(h), _.setWrapperTransition(c), _.setWrapperTranslate(u), _.onTransitionStart(), _.animating = !0, _.wrapper.transitionEnd(function() {
                            ...
                            })) : _.velocity ? (_.updateProgress(u), _.setWrapperTransition(c), _.setWrapperTranslate(u), _.onTransitionStart(), _.animating || (_.animating = !0, _.wrapper.transitionEnd(function() {
                                _ && _.onTransitionEnd()
                            }))) : _.updateProgress(u),
                            _.updateActiveIndex()
                        }
            ...
            _.effects = {
                ...
                cube: {
                    setTranslate: function() {
                        ...
                        for (var n = 0; n < _.slides.length; n++) {
                            ...
                            d = 0,
                            u = 0;
                            n % 4 === 0 ? (c = 4 * -r * _.size, u = 0) : (n - 1) % 4 === 0 ? (c = 0, u = 4 * -r * _.size) : (n - 2) % 4 === 0 ? (c = _.size + 4 * r * _.size, u = _.size) : (n - 3) % 4 === 0 && (c = -_.size, u = 3 * _.size + 4 * _.size * r),
                            _.rtl && (c = -c),
                            a() || (d = c, c = 0);
                            var h = "rotateX(" + (a() ? 0 : -o) + "deg) rotateY(" + (a() ? o: 0) + "deg) translate3d(" + c + "px, " + d + "px, " + u + "px)";
                            if (1 >= l && l > -1 && (i = 90 * n + 90 * l, _.rtl && (i = 90 * -n - 90 * l)), s.transform(h), _.params.cube.slideShadows) {
                ...
                coverflow: {
                    setTranslate: function() {
                        for (var e = _.translate,
                        i = a() ? -e + _.width / 2 : -e + _.height / 2, n = a() ? _.params.coverflow.rotate: -_.params.coverflow.rotate, s = _.params.coverflow.depth, o = 0, r = _.slides.length; r > o; o++) {
                            var l = _.slides.eq(o),
                            c = _.slidesSizesGrid[o],
                            d = l[0].swiperSlideOffset,
                            u = (i - d - c / 2) / c * _.params.coverflow.modifier,
                            h = a() ? n * u: 0,
                            p = a() ? 0 : n * u,
                            f = -s * Math.abs(u),
                            m = a() ? 0 : _.params.coverflow.stretch * u,
                            g = a() ? _.params.coverflow.stretch * u: 0;
                            Math.abs(g) < .001 && (g = 0),
                            Math.abs(m) < .001 && (m = 0),
                            Math.abs(f) < .001 && (f = 0),
                            Math.abs(h) < .001 && (h = 0),
                            Math.abs(p) < .001 && (p = 0);
                            var v = "translate3d(" + g + "px," + m + "px," + f + "px)  rotateX(" + p + "deg) rotateY(" + h + "deg)";
                            if (l.transform(v), l[0].style.zIndex = -Math.abs(Math.round(u)) + 1, _.params.coverflow.slideShadows) {
            ...
            _.lazy = {
                ...
                loadImageInSlide: function(e, i) {
                    if ("undefined" != typeof e && ("undefined" == typeof i && (i = !0), 0 !== _.slides.length)) {
                        var n = _.slides.eq(e),
                        s = n.find(".swiper-lazy:not(.swiper-lazy-loaded):not(.swiper-lazy-loading)"); ! n.hasClass("swiper-lazy") || n.hasClass("swiper-lazy-loaded") || n.hasClass("swiper-lazy-loading") || (s = s.add(n[0])),
            ...
            _.disableMousewheelControl = function() {
                return !! _.mousewheel.event && (_.container.off(_.mousewheel.event, u), !0)
            },
            _.enableMousewheelControl = function() {
                return !! _.mousewheel.event && (_.container.on(_.mousewheel.event, u), !0)
            },
            _.parallax = {
                setTranslate: function() {
            ...
            for (var R in _.plugins) {
                var z = _.plugins[R](_, _.params[R]);
                z && _._plugins.push(z)
            }
...
function(e) {
    ...
    a = {
        ...
        getData: function() {
            var o = window.sessionStorage.getItem(n.cache_prefix + "max_page");
            if (n.cache && "object" != typeof o && "undefined" != typeof o && n.pager <= o) {
                for (var r = 1; r <= o; r++) {
                    var l = window.sessionStorage.getItem(n.cache_prefix + r);
                    if ("object" != typeof l && "undefined" != typeof l) {
                        var c = JSON.parse(l);
                        template.config("openTag", "<%"),
                        template.config("closeTag", "%>");
                        var d = template(n.template, c);
                        r > 1 ? t.append(d) : t.html(d)
                    }
                }
                n.pager = o;
                var u = window.sessionStorage.getItem(n.cache_prefix + "scroll_to_index");
                return window.scrollTo(0, u - 100),
                !1
            }
            i = !0;
            var h = n.url.indexOf("?") > 0 ? "&": "?",
            p = n.url + h + "ts=" + Math.random();
            if (e.ajax({
                url: p,
                type: n.type,
                dataType: n.format,
                ...
                success: function(e) {
                    ...
                    var a = n.cache_prefix + n.pager;
                    window.sessionStorage.setItem(a, JSON.stringify(e)),
                    window.sessionStorage.setItem(n.cache_prefix + "max_page", n.pager),
                    template.config("openTag", "<%"),
                    template.config("closeTag", "%>");
                    var o = template(n.template, e);
                    n.pager > 1 ? t.append(o) : t.html(o),
                    n.pager++,
                    i = !1
                },error: function() {
					t.html('<div class="no-div-message">\n<i class="iconfont icon-biaoqingleiben"></i>\n<p>亲，此处没有内容～！</p>\n</div>');
				}
        ...
        checkScroll: function() {
            ...
            window.sessionStorage.setItem(n.cache_prefix + "scroll_to_index", t),
    ...
    e.fn.infinite = function(t) {
        ...
        : "object" != typeof t && t ? void e.error("Method " + t + " does not exist!") : a.init.apply(this, arguments)
    }
} (jQuery),
function($) {
    "use strict";
...
function() {
    ...
    h = function(e, t) {
        var i, n;
        if (u(e)) for (i = 0, n = e.length; n > i; i++) t.call(e, e[i], i, e);
    ...
    s.parser = function(e) {
        ...
        default:
            if (/^\s*\|\s*[\w\$]/.test(s)) {
                ...
                for (var u = 0,
                h = e.split("|"), p = h.length, f = h[u++]; p > u; u++) f = T(f, h[u]);
                e = (d ? "=": "=#") + f
...
function(e, t, i) {
    ...
    function s() {
        return 0 === e("#Validform_msg").length && (o = e('<div id="Validform_msg"><div class="Validform_title">' + l.tit + '<a class="Validform_close" href="javascript:void(0);">&chi;</a></div><div class="Validform_info"></div><div class="iframe"><iframe frameborder="0" scrolling="no" height="100%" width="100%"></iframe></div></div>').appendTo("body"), o.find("a.Validform_close").click(function() {
            ...
            this.blur()
        }), void e(window).bind("scroll resize",
        function() { ! r && n(o, 400)
        }))
    }
    var a = null,
    ...
    var c = function(t, n, a) {
        ...
        a !== !0 && (t.each(function() {
            ...
            s.delegate("[datatype]", "blur",
            function() {
                var e = arguments[1];
                c.util.check.call(this, s, e)
            }),
            s.delegate(":text", "keypress",
            function(e) {
            ...
            t.settings.btnSubmit && s.find(t.settings.btnSubmit).bind("click",
            function() {
            ...
            s.find("[type='reset']").add(s.find(t.settings.btnReset)).bind("click",
            function() {
    ...
    c.util = {
        ...
        enhance: function(t, i, n, s) {
            ...
            a.find(":checkbox[datatype],:radio[datatype]").each(function() {
                ...
                var t = e(this),
                i = t.attr("name");
                a.find("[name='" + i + "']").filter(":checkbox,:radio").bind("click",
                function() {
                    setTimeout(function() {
                        t.trigger("blur")
                    },
            ...
            a.find("select[datatype][multiple]").bind("click",
            function() {
                var t = e(this);
                setTimeout(function() {
                    t.trigger("blur")
        ...
        usePlugin: function(t, i, n, s) {
            ...
            if (a.find("input[plugin='datepicker']").length && e.fn.datePicker && (t.datepicker = t.datepicker || {},
            t.datepicker.format && (Date.format = t.datepicker.format, delete t.datepicker.format), t.datepicker.firstDayOfWeek && (Date.firstDayOfWeek = t.datepicker.firstDayOfWeek, delete t.datepicker.firstDayOfWeek), a.find("input[plugin='datepicker']").each(function(i) {
                return "inited" == this.validform_inited || (this.validform_inited = "inited", t.datepicker.callback && e(this).bind("dateSelected",
                function() {
            ...
            })), a.find("input[plugin*='passwordStrength']").length && e.fn.passwordStrength && (t.passwordstrength = t.passwordstrength || {},
            t.passwordstrength.showmsg = function(e, t, s) {
        ...
        getErrormsg: function(t, i, n) {
            ...
            for (var u in d) if (u.indexOf(c[1]) != -1 && o.test(u)) return s = (t.data("tipmsg").w[u] || l.w[u]).replace(r, "$1" + c[3] + "$2" + c[4] + "$3"),
        ...
        _regcheck: function(e, t, n, s) {
            ...
            if (o) {
                if (u = 2, a = n.attr("sucmsg") || s.data("tipmsg").r || l.r, n.attr("recheck")) {
                    var w = s.find("input[name='" + n.attr("recheck") + "']:first");
                    t != w.val() && (o = !1, u = 3, a = n.attr("errormsg") || c.util.getErrormsg.call(n, s, e, "recheck"))
                }
        ...
        showmsg: function(t, s, a, l) {
            if (t != i && ("bycheck" != l || !a.sweep || (!a.obj || a.obj.is(".Validform_error")) && "function" != typeof s)) {
                if (e.extend(a, {
                    curform: this
                }), "function" == typeof s) return void s(t, a, c.util.cssctl); (1 == s || "byajax" == l && 4 != s) && o.find(".Validform_info").html(t),
        ...
        check: function(t, i, n) {
            ...
            if (u && !c.util.isEmpty.call(e(this), o) && !n) {
                var h = e(this);
                if ("postform" == i ? h[0].validform_subpost = "postform": h[0].validform_subpost = "", "posting" === h[0].validform_valid && o == h[0].validform_ckvalue) return "ajax";
                h[0].validform_valid = "posting",
                h[0].validform_ckvalue = o,
                ...
                f = {
                    ...
                    success: function(i) {
                        "y" === e.trim(i.status) ? (h[0].validform_valid = "true", i.info && h.attr("sucmsg", i.info), c.util.showmsg.call(t, h.attr("sucmsg") || t.data("tipmsg").r || l.r, s.tiptype, {
                            obj: h,
                            type: 2,
                            sweep: s.tipSweep
                        },
                        "bycheck"), d.removeClass("Validform_error"), a = null, "postform" == h[0].validform_subpost && t.trigger("submit")) : (h[0].validform_valid = i.info, c.util.showmsg.call(t, i.info, s.tiptype, {
                            obj: h,
                            type: 3,
                            sweep: s.tipSweep
                    ...
                    error: function(e) {
                        ...
                        return h[0].validform_valid = e.statusText,
                        d[0].validform_ajax = null,
                        !0
                    }
                };
            ...
            return u && c.util.isEmpty.call(e(this), o) && (c.util.abort.call(d[0]), d[0].validform_valid = "true"),
            n || (c.util.showmsg.call(t, r.info, s.tiptype, {
                obj: e(this),
                type: r.type,
                sweep: s.tipSweep
        ...
        submitForm: function(t, i, n, s, o) {
            ...
            if (r.find("[datatype]").each(function() {
                ...
                if (a = n = e(this), u = c.util.regcheck.call(r, e(this).attr("datatype"), s, e(this)), !u.passed) return c.util.showmsg.call(r, u.info, t.tiptype, {
                    obj: e(this),
                    type: u.type,
                    sweep: t.tipSweep
                }),
                n.addClass("Validform_error"),
                t.showAllError ? (h && (h = !1), !0) : (n.focus(), h = !1, !1);
                ...
                a = null
            }), t.showAllError && r.find(".Validform_error:first").focus(), h) {
    ...
    c.prototype = {
        ...
        eq: function(t) {
            var i = this;
            return t >= i.forms.length ? null: (t in i.objects || (i.objects[t] = new c(e(i.forms[t]).get(), {},
            (!0))), i.objects[t])
        },
...
function() {
    ...
    t = {};
    t.PADCHAR = "=",
    t.ALPHA = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
    t.makeDOMException = function() {
        try {
    ...
    t.getbyte64 = function(e, i) {
        var n = t.ALPHA.indexOf(e.charAt(i));
        if (n === -1) throw t.makeDOMException();
        return n
    },
    t.decode = function(e) {
        e = "" + e;
        var i, n, s, a = t.getbyte64,
        o = e.length;
        if (0 === o) return e;
        if (o % 4 !== 0) throw t.makeDOMException();
        i = 0,
        e.charAt(o - 1) === t.PADCHAR && (i = 1, e.charAt(o - 2) === t.PADCHAR && (i = 2), o -= 4);
        var r = [];
        for (n = 0; n < o; n += 4) s = a(e, n) << 18 | a(e, n + 1) << 12 | a(e, n + 2) << 6 | a(e, n + 3),
        r.push(String.fromCharCode(s >> 16, s >> 8 & 255, 255 & s));
        switch (i) {
        case 1:
            s = a(e, n) << 18 | a(e, n + 1) << 12 | a(e, n + 2) << 6,
            r.push(String.fromCharCode(s >> 16, s >> 8 & 255));
            break;
        case 2:
            s = a(e, n) << 18 | a(e, n + 1) << 12,
            r.push(String.fromCharCode(s >> 16))
        }
        return r.join("")
    },
    t.getbyte = function(e, i) {
        var n = e.charCodeAt(i);
        if (n > 255) throw t.makeDOMException();
        return n
    },
    t.encode = function(e) {
        ...
        for (i = 0; i < l; i += 3) n = o(e, i) << 16 | o(e, i + 1) << 8 | o(e, i + 2),
        ...
        case 1:
            n = o(e, i) << 16,
            r.push(a.charAt(n >> 18) + a.charAt(n >> 12 & 63) + s + s);
            break;
        case 2:
            n = o(e, i) << 16 | o(e, i + 1) << 8,
            r.push(a.charAt(n >> 18) + a.charAt(n >> 12 & 63) + a.charAt(n >> 6 & 63) + s)
        }
        return r.join("")
    },
    e.pay = function(e) {
        var i = encodeURIComponent(t.encode(e));
        location.href = ROOT_URL + "pay.htm?goto=" + i
    },
    e.decode = function(e) {
...
function(e) {
    ...
    i.prototype.slide = function(t, n) {
        ...
        if (this.$element.trigger(d), !d.isDefaultPrevented()) {
            ...
            return e.support.transition && this.$element.hasClass("slide") ? (a.addClass(t), a[0].offsetWidth, s.addClass(r), a.addClass(r), s.one("bsTransitionEnd",
            function() {
                ...
                0)
            }).emulateTransitionEnd(i.TRANSITION_DURATION)) : (s.removeClass("active"), a.addClass("active"), this.sliding = !1, this.$element.trigger(h)),
            o && this.cycle(),
            this
        }
    };
...
function(e) {
    ...
    function i(t) {
        return this.each(function() {
            ...
            a = e.extend({},
            n.DEFAULTS, i.data(), "object" == typeof t && t); ! s && a.toggle && /show|hide/.test(t) && (a.toggle = !1),
...
function(e) {
    ...
    function t(t, n) {
        return this.each(function() {
            ...
            a = s.data("bs.modal"),
            o = e.extend({},
            i.DEFAULTS, s.data(), "object" == typeof t && t);
...
function(e) {
    ...
    function t(t) {
        return this.each(function() {
            var n = e(this),
            s = n.data("bs.tooltip"),
            a = "object" == typeof t && t; (s || !/destroy|hide/.test(t)) && (s || n.data("bs.tooltip", s = new i(this, a)), "string" == typeof t && s[t]())
        })
    }
    var i = function(e, t) {
        this.type = null,
...
function(e) {
    ...
    function t(t) {
        return this.each(function() {
            var n = e(this),
            s = n.data("bs.popover"),
            a = "object" == typeof t && t; (s || !/destroy|hide/.test(t)) && (s || n.data("bs.popover", s = new i(this, a)), "string" == typeof t && s[t]())
        })
    }
    var i = function(e, t) {
...
function(e) {
    ...
    c.prototype.view = function() {
        ...
        if (t.fixed || (t.top = t.hasOwnProperty("top") ? t.top: 100, t.style = t.style || "", t.style += " top:" + (i.body.scrollTop + t.top) + "px"), 2 === t.type && (t.content = '<i></i><i class="laymloadtwo"></i><i></i><div>' + (t.content || "") + "</div>"), n.innerHTML = (t.shade ? "<div " + ("string" == typeof t.shade ? 'style="' + t.shade + '"': "") + ' class="laymshade"></div>': "") + '<div class="layermmain" ' + (t.fixed ? "": 'style="position:static;"') + '><div class="section"><div class="layermchild ' + (t.className ? t.className: "") + " " + (t.type || t.shade ? "": "layermborder ") + (t.anim ? "layermanim": "") + '" ' + (t.style ? 'style="' + t.style + '"': "") + ">" + o + '<div class="layermcont">' + t.content + "</div>" + c + "</div></div></div>", !t.type || 2 === t.type) {
            var u = i[s](l[0] + t.type),
            h = u.length;
            h >= 1 && d.close(u[0].getAttribute("index"))
        }
...
function(e, t) {
    "function" == typeof define && define.amd ? define(["$"], t) : "object" == typeof exports ? module.exports = t() : e.Dialog = t(window.Zepto || window.jQuery || $)
} (this,
function(e) {
    e.fn.Dialog = function(i) {
        var n = [];
        return e(this).each(function() {
            var s = new t,
            a = e.extend({
    ...
    e.Dialog = function(i) {
        if ("alert" === i.type) {
            var n = new t,
            s = '<div class="ui-alert-title">' + i.content + "</div>",
            a = "";
            i.button ? ("boolean" == typeof i.button && (i.button = "确定"), a = '<p class="ui-dialog-action"><button class="ui-alert-submit  js-dialog-close">' + i.button + "</button></p>") : i.timer || (i.timer = 3e3),
            s += a;
            var o = e.extend({
                target: s,
                animate: !0,
        ...
        if ("confirm" === i.type) {
            var r = new t,
            s = '<div class="ui-confirm-title b-color-f">' + i.content + "</div>",
            a = "";
            i.buttons || (i.buttons = [{
                yes: "确定"
            },
            ...
            for (var l = "",
            c = 0,
            d = i.buttons.length; c < d; c++) {
                var u = i.buttons[c];
                u.yes && (l += '<td><button class="ui-confirm-submit " data-type="yes">' + u.yes + "</button></td>"),
                u.no && (l += '<td><button class="ui-confirm-no" data-type="no">' + u.no + "</button></td>"),
                u.close && (l += '<td><button class="ui-confirm-close js-dialog-close" data-type="close">' + u.close + "</button></td>")
            }
            s += a;
            var h = e.extend({
                target: s,
                ...
                beforeShow: function(t) {
                    r.touch(e(".ui-confirm-submit", t),
                    function() {
                        document.removeEventListener("touchmove", handler, !1),
                        i.callback && i.callback.call(r, "yes", t)
                    }),
                    r.touch(e(".ui-confirm-no", t),
                    function() {
                        document.removeEventListener("touchmove", handler, !1),
                        i.callback && i.callback.call(r, "no", t)
                    }),
                    r.touch(e(".ui-confirm-close", t),
                    function() {
                        i.callback && i.callback.call(r, "close", t)
                    })
                }
            },
            i);
    ...
    e.alert = function(t, i, n, s, a) {
        var o = {},
        r = {
            zIndex: 100,
            type: "alert"
        };
        o = "object" == typeof t ? e.extend(r, t) : e.extend(r, {
            content: t,
            button: i,
            timer: s,
            callback: n
        }),
        e.Dialog(e.extend(o, a))
    },
    e.confirm = function(t, i, n, s) {
        var a = {},
        o = {
            zIndex: 100,
            type: "confirm"
        };
        a = "object" == typeof t ? e.extend(o, t) : e.extend(o, {
            content: t,
            buttons: i,
            callback: n
        }),
        e.Dialog(e.extend(a, s))
    };
    var t = function() {
        var t = Math.random().toString().replace(".", "");
        this.id = "dialog_" + t,
        this.settings = {},
        this.settings.closeTpl = e('<section class="goods-show-title  of-hidden padding-all b-color-f" style="border-bottom:1px solid #F6F6F9"><h3 class="fl g-c-title-h3">配送时间</h3><div class="fr filter-date-list"><a class="ui-confirm-no">取消</a><a class=" ui-confirm-submit">确定</a></div></section>'),
        this.settings.titleTpl = e('<div class="ui-dialog-title"></div>'),
        this.timer = null,
        this.showed = !1,
        this.mask = e()
    };
    return t.prototype = {
        init: function(t) {
            ...
            this.settings, t),
            this.settings.mask && (this.mask = e('<div class="ui-dialog-mask"/>'), e("body").append(this.mask)),
            e("body").append('<div class="ui-dialog" id="' + this.id + '"></div>'),
            this.dialogContainer = e("#" + this.id);
        ...
        bindEvent: function() {
            var t = this;
            this.settings.trigger && (e(this.settings.trigger).click(function() {
                t.show()
            }), t.touch(e(this.settings.trigger),
            function() {
                t.show()
            })),
            e(this.dialogContainer).on("click", ".js-dialog-close",
            function() {
                return t.hide(),
                !1
            }),
            e(document).keydown(function(e) {
                27 === e.keyCode && t.showed && t.hide()
            }),
            e(this.dialogContainer).on("hide",
            function() {
                t.hide()
            })
        },
        ...
        hide: function() {
            var t = this;
            t.settings.beforeHide && t.settings.beforeHide.call(t, t.dialogContainer),
            this.showed = !1,
            this.mask.hide(),
            this.timer && clearInterval(this.timer),
            this.settings.animate ? (this.dialogContainer.removeClass("zoomIn").addClass("zoomOut"), setTimeout(function() {
                t.dialogContainer.hide(),
                "object" == typeof t.settings.target && e("body").append(t.dialogContainer.hide()),
                t.settings.afterHide && t.settings.afterHide.call(t, t.dialogContainer)
            },
            500)) : (this.dialogContainer.hide(), "object" == typeof this.settings.target && e("body").append(this.dialogContainer), this.settings.afterHide && this.settings.afterHide.call(this, this.dialogContainer))
        },
        show: function() {
            "string" == typeof this.settings.target ? /^(\.|\#\w+)/gi.test(this.settings.target) ? this.dailogContent = e(this.settings.target) : this.dailogContent = e("<div>" + this.settings.target + "</div>") : this.dailogContent = this.settings.target,
            this.mask.show(),
            ...
            this.showed = !0,
            e(this.settings.trigger).blur(),
            this.setPosition();
            var t = this;
            this.timer && clearInterval(this.timer),
            this.settings.fixed && (this.timer = setInterval(function() {
                t.setPosition()
            },
            1e3)),
        ...
        setPosition: function() {
            if (this.showed) {
                ...
                var t = this.settings.clientHeight || document.documentElement.clientHeight || document.body.clientHeight,
                i = this.settings.clientWidth || document.documentElement.clientWidth || document.body.clientWidth,
                n = this.width / 2,
                s = this.height / 2,
                a = i / 2 - n,
                o = t / 2 - s;
                ...
                var r = "absolute";
                e.settings.fixed && (r = "fixed"),
                e.dialogContainer.css({
                    position: r
                })
            }
        }
...
function(e, t) {
    ...
    e.widget.extend = function(i) {
        ...
        o[r].hasOwnProperty(s) && a !== t && (e.isPlainObject(a) ? i[s] = e.isPlainObject(i[s]) ? e.widget.extend({},
        i[s], a) : e.widget.extend({},
        a) : i[s] = a);
        return i
    },
    ...
    e.Widget.prototype = {
        ...
        _trigger: function(t, i, n) {
            ...
            if (n = n || {},
            i = e.Event(i), i.type = (t === this.widgetEventPrefix ? t: this.widgetEventPrefix + t).toLowerCase(), i.target = this.element[0], a = i.originalEvent, a) for (s in a) s in i || (i[s] = a[s]);
...
function(e, t) {
    ...
    e.fn.position = function(t) {
        ...
        this.each(function() {
            ...
            T = h + y + n(this, "marginBottom") + _.height,
            S = e.extend({},
            v),
            E = i(C.my, d.outerWidth(), d.outerHeight());
            "right" === t.my[0] ? S.left -= u: "center" === t.my[0] && (S.left -= u / 2),
            ...
            t.using && (c = function(e) {
                ...
                p < u && r(i + n) < p && (l.horizontal = "center"),
                m < h && r(s + a) < m && (l.vertical = "middle"),
    ...
    e.ui.position = {
        ...
        flip: {
            left: function(e, t) {
                ...
                f = -2 * t.offset[0];
                d < 0 ? (i = e.left + h + p + f + t.collisionWidth - o - a, (i < 0 || i < r(d)) && (e.left += h + p + f)) : u > 0 && (n = e.left - t.collisionPosition.marginLeft + h + p + f - l, (n > 0 || r(n) < u) && (e.left += h + p + f))
            },
            top: function(e, t) {
                var i, n, s = t.within,
                ...
                m = -2 * t.offset[1];
                d < 0 ? (n = e.top + p + f + m + t.collisionHeight - o - a, e.top + p + f + m > d && (n < 0 || n < r(d)) && (e.top += p + f + m)) : u > 0 && (i = e.top - t.collisionPosition.marginTop + p + f + m - l, e.top + p + f + m > u && (i > 0 || r(i) < u) && (e.top += p + f + m))
            }
        },
        flipfit: {
            left: function() {
...
function(e, t) {
    e.widget("ui.draggable", e.ui.mouse, {
        ...
        _mouseStop: function(t) {
            ...
            return ! (!s && "original" === this.options.helper) && ("invalid" === this.options.revert && !a || "valid" === this.options.revert && a || this.options.revert === !0 || e.isFunction(this.options.revert) && this.options.revert.call(this.element, a) ? e(this.helper).animate(this.originalPosition, parseInt(this.options.revertDuration, 10),
            function() {
    ...
    e.ui.plugin.add("draggable", "connectToSortable", {
        ...
        drag: function(t, i) {
            ...
            function() {
                ...
                this.instance._intersectsWith(this.instance.containerCache) && (a = !0, e.each(n.sortables,
                function() {
    ...
    e.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(t, i) {
            var n, s, a, o, r, l, c, d, u, h, p = e(this).data("ui-draggable"),
            f = p.options,
            m = f.snapTolerance,
            g = i.offset.left,
            ...
            r - m < g && g < l + m && c - m < y && y < d + m || r - m < g && g < l + m && c - m < b && b < d + m || r - m < v && v < l + m && c - m < y && y < d + m || r - m < v && v < l + m && c - m < b && b < d + m ? ("inner" !== f.snapMode && (n = Math.abs(c - b) <= m, s = Math.abs(d - y) <= m, a = Math.abs(r - v) <= m, o = Math.abs(l - g) <= m, n && (i.position.top = p._convertPositionTo("relative", {
                ...
                top: 0,
                left: l
            }).left - p.margins.left)), h = n || s || a || o, "outer" !== f.snapMode && (n = Math.abs(c - y) <= m, s = Math.abs(d - b) <= m, a = Math.abs(r - g) <= m, o = Math.abs(l - v) <= m, n && (i.position.top = p._convertPositionTo("relative", {
                top: c,
                left: 0
            }).top - p.margins.top), s && (i.position.top = p._convertPositionTo("relative", {
            ...
            }).left - p.margins.left)), !p.snapElements[u].snapping && (n || s || a || o || h) && p.options.snap.snap && p.options.snap.snap.call(p.element, t, e.extend(p._uiHash(), {
                snapItem: p.snapElements[u].item
            })), p.snapElements[u].snapping = n || s || a || o || h) : (p.snapElements[u].snapping && p.options.snap.release && p.options.snap.release.call(p.element, t, e.extend(p._uiHash(), {
                snapItem: p.snapElements[u].item
...
function(e, t) {
    ...
    e.ui.intersect = function(e, t, n) {
        ...
        d = t.offset.left,
        u = d + t.proportions.width,
        h = t.offset.top,
        p = h + t.proportions.height;
        switch (n) {
        case "fit":
            return d <= o && r <= u && h <= l && c <= p;
        case "intersect":
            return d < o + e.helperProportions.width / 2 && r - e.helperProportions.width / 2 < u && h < l + e.helperProportions.height / 2 && c - e.helperProportions.height / 2 < p;
        case "pointer":
            ...
            i(a, h, t.proportions.height) && i(s, d, t.proportions.width);
        case "touch":
            return (l >= h && l <= p || c >= h && c <= p || l < h && c > p) && (o >= d && o <= u || r >= d && r <= u || o < d && r > u);
        default:
            return ! 1
        }
    },
...
function(e, t) {
    ...
    e.ui.plugin.add("resizable", "containment", {
        ...
        resize: function(t) {
            ...
            c.left < (o._helper ? l.left: 0) && (o.size.width = o.size.width + (o._helper ? o.position.left - l.left: o.position.left - u.left), d && (o.size.height = o.size.width / o.aspectRatio), o.position.left = r.helper ? l.left: 0),
            ...
            n = Math.abs((o._helper ? o.offset.top - u.top: o.offset.top - l.top) + o.sizeDiff.height),
    ...
    e.ui.plugin.add("resizable", "alsoResize", {
        start: function() {
            ...
            "object" != typeof i.alsoResize || i.alsoResize.parentNode ? n(i.alsoResize) : i.alsoResize.length ? (i.alsoResize = i.alsoResize[0], n(i.alsoResize)) : e.each(i.alsoResize,
            function(e) {
                n(e)
            })
        },
        resize: function(t, i) {
            ...
            "object" != typeof s.alsoResize || s.alsoResize.nodeType ? l(s.alsoResize) : e.each(s.alsoResize,
            function(e, t) {
                l(e, t)
            })
        },
    ...
    e.ui.plugin.add("resizable", "grid", {
        resize: function() {
            ...
            f && (h -= l),
            m && (p -= c),
            /^(se|s|e)$/.test(o) ? (t.size.width = h, t.size.height = p) : /^(ne)$/.test(o) ? (t.size.width = h, t.size.height = p, t.position.top = a.top - u) : /^(sw)$/.test(o) ? (t.size.width = h, t.size.height = p, t.position.left = a.left - d) : (t.size.width = h, t.size.height = p, t.position.top = a.top - u, t.position.left = a.left - d)
        }
    })
} (jQuery),
function(e, t) {
...
function(e, t) {
    ...
    e.widget("ui.sortable", e.ui.mouse, {
        ...
        _refreshItems: function(t) {
            ...
            h = this._connectWith();
            if (h && this.ready) for (i = h.length - 1; i >= 0; i--) for (s = e(h[i]), n = s.length - 1; n >= 0; n--) a = e.data(s[n], this.widgetFullName),
            a && a !== this && !a.options.disabled && (u.push([e.isFunction(a.options.items) ? a.options.items.call(a.element[0], t, {
                item: this.currentItem
            }) : e(a.options.items, a.element), a]), this.containers.push(a));
            for (i = u.length - 1; i >= 0; i--) for (o = u[i][1], r = u[i][0], n = 0, c = r.length; n < c; n++) l = e(r[n]),
...
function(e, t) {
    ...
    e.widget("ui.accordion", {
        ...
        _animate: function(e, t, i) {
            ...
            "string" == typeof h && (o = h),
            o = o || h.easing || u.easing,
            r = r || h.duration || u.duration,
        ...
        _create: function() {
            ...
            this._on(this.menu.element, {
                ...
                menufocus: function(t, i) {
                    ...
                    var n = i.item.data("ui-autocomplete-item"); ! 1 !== this._trigger("focus", t, {
                        item: n
...
function(e, t) {
    ...
    e.widget("ui.button", {
        ...
        _create: function() {
            ...
            function() {
                return ! r.disabled && (e(this).addClass("ui-state-active"), i = this, t.document.one("mouseup",
                function() {
                    i = null
                }), void 0)
            }).bind("mouseup" + this.eventNamespace,
...
function(e, t) {
    ...
    e.extend(i.prototype, {
        ...
        _dialogDatepicker: function(t, i, n, a, r) {
            ...
            return p || (this.uuid += 1, l = "dp" + this.uuid, this._dialogInput = e("<input type='text' id='" + l + "' style='position: absolute; top: -100px; width: 0px;'/>"), this._dialogInput.keydown(this._doKeyDown), e("body").append(this._dialogInput), p = this._dialogInst = this._newInst(this._dialogInput, !1), p.settings = {},
            e.data(this._dialogInput[0], o, p)),
            s(p.settings, a || {}),
            i = i && i.constructor === Date ? this._formatDate(p, i) : i,
            this._dialogInput.val(i),
            this._pos = r ? r.length ? r: [r.pageX, r.pageY] : null,
            this._pos || (c = document.documentElement.clientWidth, d = document.documentElement.clientHeight, u = document.documentElement.scrollLeft || document.body.scrollLeft, h = document.documentElement.scrollTop || document.body.scrollTop, this._pos = [c / 2 - 100 + u, d / 2 - 150 + h]),
        ...
        _enableDatepicker: function(t) {
            ...
            s.hasClass(this.markerClassName) && (i = t.nodeName.toLowerCase(), "input" === i ? (t.disabled = !1, a.trigger.filter("button").each(function() {
                ...
                opacity: "1.0",
                cursor: ""
            })) : "div" !== i && "span" !== i || (n = s.children("." + this._inlineClass), n.children().removeClass("ui-state-disabled"), n.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled", !1)), this._disabledInputs = e.map(this._disabledInputs,
            function(e) {
                return e === t ? null: e
            }))
        },
        _disableDatepicker: function(t) {
            ...
            s.hasClass(this.markerClassName) && (i = t.nodeName.toLowerCase(), "input" === i ? (t.disabled = !0, a.trigger.filter("button").each(function() {
                ...
                opacity: "0.5",
                cursor: "default"
            })) : "div" !== i && "span" !== i || (n = s.children("." + this._inlineClass), n.children().addClass("ui-state-disabled"), n.find("select.ui-datepicker-month, select.ui-datepicker-year").prop("disabled", !0)), this._disabledInputs = e.map(this._disabledInputs,
            function(e) {
                return e === t ? null: e
        ...
        _hideDatepicker: function(t) {
            var i, n, s, a, r = this._curInst; ! r || t && r !== e.data(t, o) || this._datepickerShowing && (i = this._get(r, "showAnim"), n = this._get(r, "duration"), s = function() {
        ...
        formatDate: function(e, t, i) {
            ...
            u = "",
            h = !1;
            if (t) for (n = 0; n < e.length; n++) if (h)"'" !== e.charAt(n) || l("'") ? u += e.charAt(n) : h = !1;
        ...
        _generateHTML: function(e) {
            var t, i, n, s, a, o, r, l, c, d, u, h, p, f, m, g, v, y, b, w, _, x, C, k, T, S, E, D, I, M, j, P, N, A, O, L, $, H, R, z = new Date,
            B = this._daylightSavingAdjust(new Date(z.getFullYear(), z.getMonth(), z.getDate())),
            W = this._get(e, "isRTL"),
            ...
            for (e.drawMonth = Z, e.drawYear = ee, i = this._get(e, "prevText"), i = U ? this.formatDate(i, this._daylightSavingAdjust(new Date(ee, Z - G, 1)), this._getFormatConfig(e)) : i, n = this._canAdjustMonth(e, -1, ee, Z) ? "<a class='ui-datepicker-prev ui-corner-all' data-handler='prev' data-event='click' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (W ? "e": "w") + "'>" + i + "</span></a>": q ? "": "<a class='ui-datepicker-prev ui-corner-all ui-state-disabled' title='" + i + "'><span class='ui-icon ui-icon-circle-triangle-" + (W ? "e": "w") + "'>" + i + "</span></a>", s = this._get(e, "nextText"), s = U ? this.formatDate(s, this._daylightSavingAdjust(new Date(ee, Z + G, 1)), this._getFormatConfig(e)) : s, a = this._canAdjustMonth(e, 1, ee, Z) ? "<a class='ui-datepicker-next ui-corner-all' data-handler='next' data-event='click' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (W ? "w": "e") + "'>" + s + "</span></a>": q ? "": "<a class='ui-datepicker-next ui-corner-all ui-state-disabled' title='" + s + "'><span class='ui-icon ui-icon-circle-triangle-" + (W ? "w": "e") + "'>" + s + "</span></a>", o = this._get(e, "currentText"), r = this._get(e, "gotoCurrent") && e.currentDay ? Q: B, o = U ? this.formatDate(o, r, this._getFormatConfig(e)) : o, l = e.inline ? "": "<button type='button' class='ui-datepicker-close ui-state-default ui-priority-primary ui-corner-all' data-handler='hide' data-event='click'>" + this._get(e, "closeText") + "</button>", c = F ? "<div class='ui-datepicker-buttonpane ui-widget-content'>" + (W ? l: "") + (this._isInRange(e, r) ? "<button type='button' class='ui-datepicker-current ui-state-default ui-priority-secondary ui-corner-all' data-handler='today' data-event='click'>" + o + "</button>": "") + (W ? "": l) + "</div>": "", d = parseInt(this._get(e, "firstDay"), 10), d = isNaN(d) ? 0 : d, u = this._get(e, "showWeek"), h = this._get(e, "dayNames"), p = this._get(e, "dayNamesMin"), f = this._get(e, "monthNames"), m = this._get(e, "monthNamesShort"), g = this._get(e, "beforeShowDay"), v = this._get(e, "showOtherMonths"), y = this._get(e, "selectOtherMonths"), b = this._getDefaultDate(e), w = "", _, x = 0; x < V[0]; x++) {
                for (C = "", this.maxRows = 4, k = 0; k < V[1]; k++) {
                    ...
                    for (E += "<div class='ui-datepicker-header ui-widget-header ui-helper-clearfix" + S + "'>" + (/all|left/.test(S) && 0 === x ? W ? a: n: "") + (/all|right/.test(S) && 0 === x ? W ? n: a: "") + this._generateMonthYearHeader(e, Z, ee, K, J, x > 0 || k > 0, f, m) + "</div><table class='ui-datepicker-calendar'><thead><tr>", D = u ? "<th class='ui-datepicker-week-col'>" + this._get(e, "weekHeader") + "</th>": "", _ = 0; _ < 7; _++) I = (_ + d) % 7,
                    D += "<th" + ((_ + d + 6) % 7 >= 5 ? " class='ui-datepicker-week-end'": "") + "><span title='" + h[I] + "'>" + p[I] + "</span></th>";
                    for (E += D + "</tr></thead><tbody>", M = this._getDaysInMonth(ee, Z), ee === e.selectedYear && Z === e.selectedMonth && (e.selectedDay = Math.min(e.selectedDay, M)), j = (this._getFirstDayOfMonth(ee, Z) - d + 7) % 7, P = Math.ceil((j + M) / 7), N = X && this.maxRows > P ? this.maxRows: P, this.maxRows = N, A = this._daylightSavingAdjust(new Date(ee, Z, 1 - j)), O = 0; O < N; O++) {
                        for (E += "<tr>", L = u ? "<td class='ui-datepicker-week-col'>" + this._get(e, "calculateWeek")(A) + "</td>": "", _ = 0; _ < 7; _++) $ = g ? g.apply(e.input ? e.input[0] : null, [A]) : [!0, ""],
                        H = A.getMonth() !== Z,
                        R = H && !y || !$[0] || K && A < K || J && A > J,
                        L += "<td class='" + ((_ + d + 6) % 7 >= 5 ? " ui-datepicker-week-end": "") + (H ? " ui-datepicker-other-month": "") + (A.getTime() === T.getTime() && Z === e.selectedMonth && e._keyEvent || b.getTime() === A.getTime() && b.getTime() === T.getTime() ? " " + this._dayOverClass: "") + (R ? " " + this._unselectableClass + " ui-state-disabled": "") + (H && !v ? "": " " + $[1] + (A.getTime() === Q.getTime() ? " " + this._currentClass: "") + (A.getTime() === B.getTime() ? " ui-datepicker-today": "")) + "'" + (H && !v || !$[2] ? "": " title='" + $[2].replace(/'/g, "&#39;") + "'") + (R ? "": " data-handler='selectDay' data-event='click' data-month='" + A.getMonth() + "' data-year='" + A.getFullYear() + "'") + ">" + (H && !v ? "&#xa0;": R ? "<span class='ui-state-default'>" + A.getDate() + "</span>": "<a class='ui-state-default" + (A.getTime() === B.getTime() ? " ui-state-highlight": "") + (A.getTime() === Q.getTime() ? " ui-state-active": "") + (H ? " ui-priority-secondary": "") + "' href='#'>" + A.getDate() + "</a>") + "</td>",
                    ...
                    Z++,
                    Z > 11 && (Z = 0, ee++),
                    E += "</tbody></table>" + (X ? "</div>" + (V[0] > 0 && k === V[1] - 1 ? "<div class='ui-datepicker-row-break'></div>": "") : ""),
                    C += E
                }
                w += C
            }
...
function(e, t) {
    ...
    e.widget("ui.dialog", {
        ...
        open: function() {
            var t = this;
            return this._isOpen ? void(this._moveToTop() && this._focusTabbable()) : (this._isOpen = !0, this.opener = e(this.document[0].activeElement), this._size(), this._position(), this._createOverlay(), this._moveToTop(null, !0), this._show(this.uiDialog, this.options.show,
            function() {
                t._focusTabbable(),
                t._trigger("focus")
        ...
        _createButtons: function() {
            ...
            e.isEmptyObject(i) || e.isArray(i) && !i.length ? void this.uiDialog.removeClass("ui-dialog-buttons") : (e.each(i,
            function(i, n) {
                var s, a;
                n = e.isFunction(n) ? {
                    click: n,
        ...
        _createOverlay: function() {
            this.options.modal && (e.ui.dialog.overlayInstances || this._delay(function() {
                ...
                function(t) { ! e(t.target).closest(".ui-dialog").length && !e(t.target).closest(".ui-datepicker").length && (t.preventDefault(), e(".ui-dialog:visible:last .ui-dialog-content").data("ui-dialog")._focusTabbable())
                })
    ...
    e.uiBackCompat !== !1 && e.widget("ui.dialog", e.ui.dialog, {
        _position: function() {
            ...
            n = [],
            s = [0, 0];
            i ? (("string" == typeof i || "object" == typeof i && "0" in i) && (n = i.split ? i.split(" ") : [i[0], i[1]], 1 === n.length && (n[1] = n[0]), e.each(["left", "top"],
            function(e, t) { + n[e] === n[e] && (s[e] = n[e], n[e] = t)
            }), i = {
        ...
        _create: function() {
            ...
            this._on({
                ...
                "click .ui-menu-item:has(a)": function(t) {
                    var i = e(t.target).closest(".ui-menu-item"); ! this.mouseHandled && i.not(".ui-state-disabled").length && (this.mouseHandled = !0, this.select(t), i.has(".ui-menu").length ? this.expand(t) : this.element.is(":focus") || (this.element.trigger("focus", [!0]), this.active && 1 === this.active.parents(".ui-menu").length && clearTimeout(this.timer)))
                },
    ...
    e.widget("ui.slider", e.ui.mouse, {
        ...
        _mouseCapture: function(t) {
            ...
            n = this._normValueFromMouse(i), s = this._valueMax() - this._valueMin() + 1, this.handles.each(function(t) {
                var i = Math.abs(n - d.values(t)); (s > i || s === i && (t === d._lastChangedValue || d.values(t) === u.min)) && (s = i, a = e(this), o = t)
...
function(e, t) {
    ...
    e.widget("ui.tabs", {
        ...
        _create: function() {
            ...
            e.isArray(i.disabled) && (i.disabled = e.unique(i.disabled.concat(e.map(this.tabs.filter(".ui-state-disabled"),
            function(e) {
        ...
        enable: function(i) {
            ...
            n !== !1 && (i === t ? n = !1 : (i = this._getIndex(i), n = e.isArray(n) ? e.map(n,
            function(e) {
                return e !== i ? e: null
            }) : e.map(this.tabs,
            function(e, t) {
...
function(e) {
    ...
    e.widget("ui.tooltip", {
        ...
        _setOption: function(t, i) {
            var n = this;
            return "disabled" === t ? (this[i ? "_disable": "_enable"](), void(this.options[t] = i)) : (this._super(t, i), void("content" === t && e.each(this.tooltips,
            function(e, t) {
                n._updateContent(t)
            })))
        },
        ...
        close: function(t) {
            ...
            }), s.removeData("ui-tooltip-open"), this._off(s, "mouseleave focusout keyup"), s[0] !== this.element[0] && this._off(s, "remove"), this._off(this.document, "mousemove"), t && "mouseleave" === t.type && e.each(this.parents,
            function(t, i) {
    ...
    function(e, t) {
        ...
        c.fn = e.extend(c.prototype, {
            parse: function(s, o, r, l) {
                ...
                this; (s.jquery || s.nodeType) && (s = e(s).css(o), o = t);
                var u = this,
                h = e.type(s),
                p = this._rgba = [];
                return o !== t && (s = [s, o, r, l], h = "array"),
                "string" === h ? this.parse(n(s) || a._default) : "array" === h ? (f(d.rgba.props,
                function(e, t) {
                    p[t.idx] = i(s[t.idx], t)
                }), this) : "object" === h ? (s instanceof c ? f(d,
                function(e, t) {
        ...
        d.hsla.to = function(e) {
            ...
            i = 0 === c ? 0 : u <= .5 ? c / d: c / (2 - d),
            [Math.round(t) % 360, i, u, null == o ? 1 : o]
        },
...
function(e, t) {
    ...
    e.effects.effect.blind = function(t, s) {
        ...
        g[p] = v ? o: 0,
        m || (l.css(h ? "bottom": "right", 0).css(h ? "top": "left", "auto").css({
            position: "absolute"
        }), g[f] = v ? r: o + r),
...
function(e, t) {
    e.effects.effect.bounce = function(t, i) {
        ...
        a[v] = 0, o.css("opacity", 0).css(v, y ? 2 * -h: 2 * h).animate(a, m, g)), c && (h /= Math.pow(2, p - 1)), a = {},
        a[v] = 0, n = 0; n < p; n++) s = {},
        s[v] = (y ? "-=": "+=") + h,
...
function(e, t) {
    e.effects.effect.explode = function(t, i) {
        ...
        b = [];
        for (a = 0; a < u; a++) for (l = g.top + a * y, d = a - (u - 1) / 2, o = 0; o < h; o++) r = g.left + o * v,
        c = o - (h - 1) / 2,
...
function(e, t) {
    e.effects.effect.fold = function(t, i) {
        ...
        u && (d = parseInt(u[1], 10) / 100 * s[c ? 0 : 1]),
        l && n.css(h ? {
            height: 0,
            width: d
        }: {
        ...
        g[f[0]] = l ? s[0] : d,
        v[f[1]] = l ? s[1] : 0,
        n.animate(g, m, t.easing).animate(v, m, t.easing,
        function() {
            c && a.hide(),
...
function(e, t) {
    e.effects.effect.pulsate = function(t, i) {
        ...
        h = s.queue(),
        p = h.length;
        for (!o && s.is(":visible") || (s.css("opacity", 0).show(), u = 1), n = 1; n < c; n++) s.animate({
            opacity: u
        },
        d, t.easing),
        u = 1 - u;
...
function(e, t) {
    ...
    e.effects.effect.size = function(t, i) {
        ...
        "box" !== m && "both" !== m || (a.from.y !== a.to.y && (y = y.concat(u), o.from = e.effects.setTransition(o, u, a.from.y, o.from), o.to = e.effects.setTransition(o, u, a.to.y, o.to)), a.from.x !== a.to.x && (y = y.concat(h), o.from = e.effects.setTransition(o, h, a.from.x, o.from), o.to = e.effects.setTransition(o, h, a.to.x, o.to))),
        ...
        o.css(o.from),
        "content" !== m && "both" !== m || (u = u.concat(["marginTop", "marginBottom"]).concat(d), h = h.concat(["marginLeft", "marginRight"]), c = r.concat(u).concat(h), o.find("*[width]").each(function() {
            var i = e(this),
            n = {
                height: i.height(),
                width: i.width(),
            ...
            a.from.y !== a.to.y && (i.from = e.effects.setTransition(i, u, a.from.y, i.from), i.to = e.effects.setTransition(i, u, a.to.y, i.to)),
            a.from.x !== a.to.x && (i.from = e.effects.setTransition(i, h, a.from.x, i.from), i.to = e.effects.setTransition(i, h, a.to.x, i.to)),
            i.css(i.from),
...
function(e, t) {
    e.effects.effect.shake = function(t, i) {
        ...
        v = s.queue(),
        y = v.length;
        for (e.effects.save(s, a), s.show(), e.effects.createWrapper(s), f[h] = (p ? "-=": "+=") + l, m[h] = (p ? "+=": "-=") + 2 * l, g[h] = (p ? "-=": "+=") + 2 * l, s.animate(f, u, t.easing), n = 1; n < c; n++) s.animate(m, u, t.easing).animate(g, u, t.easing);
...
function(e) {
    ...
    if (e.support.touch = "ontouchend" in document, e.support.touch) {
        ...
        n._touchStart = function(e) {
            var n = this; ! i && n._mouseCapture(e.originalEvent.changedTouches[0]) && (i = !0, n._touchMoved = !1, t(e, "mouseover"), t(e, "mousemove"), t(e, "mousedown"))
        },
...
function(e, t, i) {
    ...
    e.fn.scrollUp.init = function(n) {
        var s, a, o, r, l, c, d, u = e.fn.scrollUp.settings = e.extend({},
        e.fn.scrollUp.defaults, n),
        h = !1;
        ...
        r = "top" === u.scrollFrom ? u.scrollDistance: e(i).height() - e(t).height() - u.scrollDistance,
        l = e(t).scroll(function() {
            e(t).scrollTop() > r ? h || (d[s](o), h = !0) : h && (d[a](o), h = !1)
        }),
        u.scrollTarget ? "number" == typeof u.scrollTarget ? c = u.scrollTarget: "string" == typeof u.scrollTarget && (c = Math.floor(e(u.scrollTarget).offset().top)) : c = 0,
        d.click(function(t) {
            t.preventDefault(),
            e("html, body").animate({
                scrollTop: c
...
function(e, t) {
    "function" == typeof define && define.amd ? define(["$", "dialog"], t) : "function" == typeof define && define.cmd ? define(function(e, i, n) {
        var s = e("$"),
        a = e("dialog");
        return t(s, a)
    }) : "object" == typeof exports ? module.exports = t() : e.MobileSelectArea = t(window.Zepto || window.jQuery || $)
} (this,
function(e, t) {
    var i = function() {
    ...
    return i.prototype = {
        init: function(t) {
            ...
            t),
            this.trigger = e(this.settings.trigger),
            void 0 == this.settings["default"] ? this["default"] = 1 : this["default"] = 0,
        ...
        getData: function() {
            var t = this,
            i = e.Deferred();
            return "object" == typeof this.settings.data ? (this.data = this.settings.data, i.resolve()) : e.ajax({
                dataType: "json",
                cache: !0,
        ...
        bindEvent: function() {
            var t = this;
            this.trigger[t.settings.eventName](function(i) {
                for (var n = "",
                s = 0; s < t.level; s++) n += "<div></div>";
                e.confirm('<div class="ui-scroller-mask"><div id="' + t.id + '" class="ui-scroller">' + n + "<p></p></div></div>", null,
                function(e, i) {
                    "yes" == e && t.submit(),
                    "no" == e && t.cancel(),
                    this.dispose()
                ...
                {}),
                t.scroller = e("#" + t.id),
                t.getData().done(function() {
                    t.format()
                });
                var a = 0,
                o = 0;
                return t.scroller.children().bind("touchstart",
                function(e) {
                    a = (e.changedTouches || e.originalEvent.changedTouches)[0].pageY
                }),
                t.scroller.children().bind("touchmove",
                function(t) {
                    o = (t.changedTouches || t.originalEvent.changedTouches)[0].pageY;
                    var i = o - a,
                    n = e(t.target).parent();
                    if ("DL" == n[0].nodeName) {
                        var s = parseInt(n.css("top") || 0) + i;
                        return n.css("top", s),
                        a = o,
                        !1
                    }
                }),
                t.scroller.children().bind("touchend",
                function(i) {
                    o = (i.changedTouches || i.originalEvent.changedTouches)[0].pageY;
                    var n = o - a,
                    s = e(i.target).parent();
                    if ("DL" == s[0].nodeName) {
                        var r = e(s.parent()).index(),
                        l = parseInt(s.css("top") || 0) + n;
                        l > t.mtop && (l = t.mtop),
                        l < -e(s).height() + 60 && (l = -e(s).height() + 60);
                        var c = l / t.mtop,
                        d = Math.round(c),
                        u = Math.abs(d) + 1;
                        1 == d && (u = 0),
                        t.value[r] = e(s.children().get(u)).attr("ref"),
                        0 == t.value[r] ? t.text[r] = "": t.text[r] = e(s.children().get(u)).html();
                        for (var h = t.level - 1; h > r; h--) t.value[h] = 0,
                        t.text[h] = "";
                        return e(s.children().get(u)).hasClass("focus") || t.format(),
                        e(s.children().get(u)).addClass("focus").siblings().removeClass("focus"),
                        s.css("top", d * t.mtop),
                        !1
                    }
                }),
        ...
        f: function(t) {
            ...
            n = t;
            n || (n = []);
            var s, a = '<dl><dd ref="0">——</dd>',
            o = 0,
            r = i.mtop;
            if (0 !== i.index && "0" == i.value[i.index - 1] && 0 == this["default"]) a = '<dl><dd ref="0" class="focus">——</dd>',
            i.value[i.index] = 0,
            i.text[i.index] = "",
            o = 0;
            else {
                if ("0" == i.value[i.index] && (a = '<dl><dd ref="0" class="focus">——</dd>', o = 0), n.length > 0 && 1 == this["default"]) {
                    a = "<dl>";
                    var l = n[0].pid || 0,
                    c = n[0].id || 0;
                    o = n[0].id,
                    s = n[0].child,
                    void 0 == i.value[this.index] && (i.value[this.index] = n[n.length - 1].id || 0, i.text[this.index] = n[n.length - 1].name),
                    i.value[this.index] || (i.value[this.index] = c, i.text[this.index] = n[0].name),
                    a += '<dd pid="' + l + '" class="' + h + '" ref="' + c + '">' + n[0].name + "</dd>"
                }
                for (var d = i["default"], u = n.length; d < u; d++) {
                    var l = n[d].pid || 0,
                    c = n[d].id || 0,
                    h = "";
                    i.value[i.index] == c && (h = "focus", o = c, s = n[d].child, r = i.mtop * -(d - i["default"])),
                    a += '<dd pid="' + l + '" class="' + h + '" ref="' + c + '">' + n[d].name + "</dd>"
                }
            }
            a += "</dl>";
            var p = e(a);
            p.css("top", r);
            var f = i.scroller.children();
            return e(f[i.index]).html(p),
            i.index++,
            i.index > i.level - 1 ? void(i.index = 0) : void i.f(s)
        },
        submit: function() {
            this.settings.callback && this.settings.callback.call(this, this.scroller, this.text, this.value) && (this.oldvalue = this.value.concat([]), this.oldtext = this.text.concat([]), 1 == this.trigger[0].nodeType && (this.trigger.val(this.text.join(this.separator)), this.trigger.attr("data-value", this.value.join(","))), this.trigger.next(":hidden").val(this.value.join(",")))
        },
        cancel: function() {
...
var funParabola = function(e, t, i) {
    ...
    if (e && t && 1 == e.nodeType && 1 == t.nodeType) {
        ...
        v = {};
        o.mark = function() {
            return 0 == u ? this: ("undefined" == typeof g.x && this.position(), e.setAttribute("data-center", [g.x, g.y].join()), t.setAttribute("data-center", [v.x, v.y].join()), this)
        },
        o.position = function() {
            if (0 == u) return this;
            ...
            f = {
                x: h.left + (h.right - h.left) / 2 + i,
                y: h.top + (h.bottom - h.top) / 2 + n
            },
            m = {
        ...
        o.move = function() {
            ...
            n = function() {
                ...
                t !== v.x ? (s.progress(o, l), window.requestAnimationFrame(n)) : (s.complete(), u = !0)
            };
...
function() {
    ...
    function(e, t, i) {
        ...
        function s() {
            function e() {
                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : o["default"].noop;
                a.addClass("weui-animate-fade-out"),
                s.addClass("weui-animate-fade-out").on("animationend webkitAnimationEnd",
                function() {
                    n.remove(),
                    d = !1,
                    e()
            ...
            t = o["default"].extend({
                ...
                buttons: [{
                    label: "确定",
                    type: "primary",
                    onClick: o["default"].noop
                }],
                isAndroid: i
            },
            t);
            var n = (0, o["default"])(o["default"].render(l["default"], t)),
            s = n.find(".weui-dialog"),
            a = n.find(".weui-mask");
            return c.append(n),
            a.addClass("weui-animate-fade-in"),
            s.addClass("weui-animate-fade-in"),
            n.on("click", ".weui-dialog__btn",
            function(i) {
                var n = this,
                s = (0, o["default"])(this).index();
                e(function() {
                    t.buttons[s].onClick && t.buttons[s].onClick.call(n, i)
                })
            }),
            n.hide = e,
            d = n,
    ...
    function(e, t, i) {
        ...
        l = i(5),
        c = n(l);
        s.call(c["default"], navigator.userAgent),
        (0, r["default"])(c["default"].fn, {
            append: function(e) {
            ...
            off: function(e, t, i) {
                return "function" == typeof t && (i = t, t = null),
        ...
        (0, r["default"])(c["default"], {
            ...
            noop: function() {},
            render: function(e, t) {
                var i = "var p=[],print=function(){p.push.apply(p,arguments);};with(this){p.push('" + e.replace(/[\r\t\n]/g, " ").split("<%").join("\t").replace(/((^|%>)[^\t]*)'/g, "$1\r").replace(/\t=(.*?)%>/g, "',$1,'").split("\t").join("');").split("%>").join("p.push('").split("\r").join("\\'") + "');}return p.join('');";
                return new Function(i).apply(t)
            },
            getStyle: function(e, t) {
                var i, n = (e.ownerDocument || document).defaultView;
                return n && n.getComputedStyle ? (t = t.replace(/([A-Z])/g, "-$1").toLowerCase(), n.getComputedStyle(e, null).getPropertyValue(t)) : e.currentStyle ? (t = t.replace(/\-(\w)/g,
                function(e, t) {
                    return t.toUpperCase()
                }), i = e.currentStyle[t], /^\d+(em|pt|%|ex)?$/i.test(i) ?
                function(t) {
                    var i = e.style.left,
    ...
    function(e, t) {
        ...
        function(e) {
            for (var t = this,
            i = (t.document || t.ownerDocument).querySelectorAll(e), n = 0; i[n] && i[n] !== t;)++n;
            return Boolean(i[n])
        }),
    ...
    function(e, t) {
        ...
        e.exports = n() ? Object.assign: function(e, t) {
            for (var n, o, r = i(e), l = 1; l < arguments.length; l++) {
                n = Object(arguments[l]);
                for (var c in n) s.call(n, c) && (r[c] = n[c]);
                if (Object.getOwnPropertySymbols) {
                    o = Object.getOwnPropertySymbols(n);
                    for (var d = 0; d < o.length; d++) a.call(n, o[d]) && (r[o[d]] = n[o[d]])
                }
            }
            return r
        }
    ...
    function(e, t, i) {
        ...
        function(i, a) {
            a = function(e, t, i) {
                function n(s, a, o) {
                    return o = Object.create(n.fn),
                    s && o.push.apply(o, s[t] ? [s] : "" + s === s ? /</.test(s) ? ((a = e.createElement(a || t)).innerHTML = s, a.children) : a ? (a = n(a)[0]) ? a[i](s) : o: e[i](s) : "function" == typeof s ? e.readyState[7] ? s() : e[t]("DOMContentLoaded", s) : s),
                    o
                }
                return n.fn = [],
                n.one = function(e, t) {
    ...
    function(e, t, i) {
        ...
        function s() {
            ...
            t = arguments[1],
            i = arguments[2],
            n = "object" === ("undefined" == typeof t ? "undefined": a(t));
            return n && (i = t),
            i = r["default"].extend({
                content: e,
                buttons: [{
    ...
    function(e, t, i) {
        ...
        function s() {
            ...
            i = arguments[2],
            n = arguments[3],
            s = "object" === ("undefined" == typeof t ? "undefined": a(t));
            return s && (n = t),
            n = r["default"].extend({
                content: e,
                buttons: [{
                    label: "取消",
                    type: "default",
                    onClick: s ? r["default"].noop: i
                },
                {
                    label: "确定",
                    type: "primary",
                    onClick: s ? r["default"].noop: t
                }]
            },
            n),
            (0, c["default"])(n)
    ...
    function(e, t, i) {
        ...
        function s() {
            ...
            t);
            var i = (0, o["default"])(o["default"].render(l["default"], {
                content: e
            }));
            return c.append(i),
            i.addClass("weui-animate-fade-in"),
            setTimeout(function() {
                i.addClass("weui-animate-fade-out").on("animationend webkitAnimationEnd",
                function() {
                    i.remove(),
                    d = !1,
                    t.callback()
    ...
    function(e, t, i) {
        ...
        function s() {
            function e() {
                a.addClass(n ? "weui-animate-fade-out": "weui-animate-slide-down"),
                r.addClass("weui-animate-fade-out").on("animationend webkitAnimationEnd",
                function() {
                    s.remove(),
                    d = !1
                })
            ...
            s = (0, o["default"])(o["default"].render(l["default"], {
                menus: t,
                actions: i,
                isAndroid: n
            })),
            a = s.find(".weui-actionsheet"),
            r = s.find(".weui-mask");
            return c.append(s),
            o["default"].getStyle(a[0], "transform"),
            a.addClass(n ? "weui-animate-fade-in": "weui-animate-slide-up"),
            r.addClass("weui-animate-fade-in").on("click", e),
            s.find(".weui-actionsheet__menu").on("click", ".weui-actionsheet__cell",
            function(i) {
                var n = (0, o["default"])(this).index();
                t[n].onClick.call(this, i),
                e()
            }),
            s.find(".weui-actionsheet__action").on("click", ".weui-actionsheet__cell",
            function(t) {
                var n = (0, o["default"])(this).index();
                i[n].onClick.call(this, t),
                e()
            }),
            s.hide = e,
            d = s,
    ...
    function(e, t, i) {
        ...
        function s(e) {
            ...
            i);
            var n = (0, o["default"])(o["default"].render(l["default"], {
                content: e
            }));
            return c.append(n),
            d && (clearTimeout(d.timeout), d.hide()),
            d = {
                hide: t
            },
            d.timeout = setTimeout(t, i.duration),
            n.hide = t,
            n
        }
        Object.defineProperty(t, "__esModule", {
    ...
    function(e, t, i) {
        ...
        function s(e) {
            ...
            return t.forEach(function(e) {
                function t() {
                    s.val(""),
                    i.removeClass("weui-search-bar_focusing")
                }
                var i = (0, o["default"])(e),
                n = i.find(".weui-search-bar__label"),
                s = i.find(".weui-search-bar__input"),
                a = i.find(".weui-icon-clear"),
                r = i.find(".weui-search-bar__cancel-btn");
                n.on("click",
                function() {
                    i.addClass("weui-search-bar_focusing"),
                    s[0].focus()
                }),
                s.on("blur",
                function() {
    ...
    function(e, t, i) {
        ...
        function s(e) {
            ...
            i.forEach(function(e) {
                var i = (0, o["default"])(e),
                n = i.find(".weui-navbar__item, .weui-tabbar__item"),
                s = i.find(".weui-tab__content");
                n.eq(t.defaultIndex).addClass("weui-bar__item_on"),
                s.eq(t.defaultIndex).show(),
                n.on("click",
                function() {
                    var e = (0, o["default"])(this),
                    i = e.index();
                    n.removeClass("weui-bar__item_on"),
                    e.addClass("weui-bar__item_on"),
                    s.hide(),
                    s.eq(i).show(),
                    t.onChange.call(this, i)
                })
            }),
            this
        }
    ...
    function(e, t, i) {
        ...
        function s(e) {
            return e && e.classList ? e.classList.contains("weui-cell") ? e: s(e.parentNode) : null
        }
        function a(e, t, i) {
            var n = e[0],
            s = e.val();
            if ("INPUT" == n.tagName || "TEXTAREA" == n.tagName) {
                var a = n.getAttribute("required") || n.getAttribute("pattern") || "";
                if ("radio" == n.type) {
                    for (var o = t.find('input[type="radio"][name="' + n.name + '"]'), r = 0, l = o.length; r < l; ++r) if (o[r].checked) return null;
                    return "empty"
                }
                if ("checkbox" != n.type) {
                    if (e.val().length) {
                        if (a) {
                            if (/^REG_/.test(a)) {
                                if (!i) throw "RegExp " + a + " is empty.";
                                if (a = a.replace(/^REG_/, ""), !i[a]) throw "RegExp " + a + " has not found.";
                                a = i[a]
                            }
                            return new RegExp(a).test(s) ? null: "notMatch"
                        }
                        return null
                    }
                    return "empty"
                }
                if (!a) return n.checked ? null: "empty";
                var d = function() {
                    var e = t.find('input[type="checkbox"][name="' + n.name + '"]'),
                    i = a.replace(/[{\s}]/g, "").split(","),
                    s = 0;
                    if (2 != i.length) throw n.outerHTML + " regexp is wrong.";
                    return e.forEach(function(e) {
                        e.checked && ++s
                    }),
                    s ? "" === i[1] ? s >= parseInt(i[0]) ? {
                        v: null
                    }: {
                        v: "notMatch"
                    }: parseInt(i[0]) <= s && s <= parseInt(i[1]) ? {
                        v: null
                    }: {
                        v: "notMatch"
                    }: {
                ...
                if ("object" === ("undefined" == typeof d ? "undefined": c(d))) return d.v
            } else if (s.length) return null;
            return "empty"
        }
        function o(e) {
            if (e) {
                var t = (0, u["default"])(e.ele),
                i = e.msg,
                n = t.attr(i + "Tips") || t.attr("tips") || t.attr("placeholder");
                if (n && (0, p["default"])(n), "checkbox" == e.ele.type || "radio" == e.ele.type) return;
                var a = s(e.ele);
        ...
        function l(e) {
            ...
            return i.forEach(function(e) {
                var i = (0, u["default"])(e);
                i.find("[required]").on("blur",
                function() {
                    if ("checkbox" != this.type && "radio" != this.type) {
                        var e = (0, u["default"])(this);
                        if (! (e.val().length < 1)) {
                            var n = a(e, i, t.regexp);
                            n && o({
                                ele: e[0],
                                msg: n
                            })
    ...
    function(e, t, i) {
        ...
        function s(e, t) {
            function i(e, t) {
                var i = e.find('[data-id="' + t + '"]'),
                n = i.find(".weui-uploader__file-content");
                return n.length || (n = (0, o["default"])('<div class="weui-uploader__file-content"></div>'), i.append(n)),
                i.addClass("weui-uploader__file_status"),
                n
            }
            function n(e, t) {
            ...
            function s(e) {
                e.url = r.createObjectURL(e),
                e.upload = function() { (0, u["default"])(o["default"].extend({
                        $uploader: a,
                        file: e
                    },
                    t))
            ...
            t),
            t.compress !== !1 && (t.compress = o["default"].extend({
                width: 1600,
                height: 1600,
                quality: .8
            },
            ...
            function() {
                ...
                t.onBeforeQueued = function(t, i) {
                    ...
                    if (n === !1) return ! 1;
                    if (n !== !0) {
                        var s = (0, o["default"])(o["default"].render(l["default"], {
                            id: t.id
                        }));
            ...
            function() {
                ...
                t.onQueued = function(i) {
                    if (!e.call(i)) {
                        var s = a.find('[data-id="' + i.id + '"]');
                        s.css({
                            backgroundImage: 'url("' + (i.base64 || i.url) + '")'
                        }),
                        t.auto || n(a, i.id)
                    }
                }
            ...
            function() {
                ...
                t.onError = function(t, n) {
                    e.call(t, n) || i(a, t.id).html('<i class="weui-icon-warn"></i>')
                }
            } (),
            a.find('input[type="file"]').on("change",
            function(e) {
                var i = e.target.files;
                0 !== i.length && (t.compress === !1 && "file" == t.type ? Array.prototype.forEach.call(i,
                function(e) {
                    e.id = ++h,
                    t.onBeforeQueued(e, i) !== !1 && s(e)
                }) : Array.prototype.forEach.call(i,
                function(e) {
                    e.id = ++h,
                    t.onBeforeQueued(e, i) !== !1 && (0, c.compress)(e, t,
                    function(e) {
                        e && s(e)
                    })
                }), this.value = "")
    ...
    function(e, t) {
        ...
        function n(e) {
            for (var t = atob(e.split(",")[1]), i = e.split(",")[0].split(":")[1].split(";")[0], n = new ArrayBuffer(t.length), s = new Uint8Array(n), a = 0; a < t.length; a++) s[a] = t.charCodeAt(a);
            return new Blob([n], {
                type: i
            })
        }
        function s(e, t, s) {
            ...
            a.onload = function(a) {
                if (t.compress === !1) return e.base64 = a.target.result,
                void s(e);
                var o = new Image;
                o.onload = function() {
                    var a = i(o),
                    ...
                    h = o.height,
                    p = void 0;
                    if (u < h && h > d ? (u = parseInt(d * o.width / o.height), h = d) : u >= h && u > c && (h = parseInt(c * o.height / o.width), u = c), r.width = u, r.height = h, l.drawImage(o, 0, 0, u, h / a), p = /image\/jpeg/.test(e.type) || /image\/jpg/.test(e.type) ? r.toDataURL("image/jpeg", t.compress.quality) : r.toDataURL(e.type), "file" == t.type) if (/;base64,null/.test(p) || /;base64,$/.test(p)) s(e);
                    else {
                        var f = n(p);
                        f.id = e.id,
                        f.name = e.name,
                        f.lastModified = e.lastModified,
                        f.lastModifiedDate = e.lastModifiedDate,
                        s(f)
                    } 
					/*
					else / ;
                    base64,
                    null / .test(p) || /;base64,$/.test(p) ? (t.onError(e, new Error("Compress fail, dataURL is " + p + ".")), s()) : (e.base64 = p, s(e))
					*/
                },
    ...
    function(e, t) {
        ...
        function i(e) {
            ...
            l = i.name,
            c = i.type,
            d = i.lastModifiedDate,
            u = {
                name: l,
                type: c,
                size: "file" == e.type ? i.size: i.base64.length,
                lastModifiedDate: d
            },
            h = {};
            if (s(i, u, h) !== !1) {
                ...
                "file" == e.type ? p.append(n, i, l) : p.append(n, i.base64),
                f.onreadystatechange = function() {
                    if (4 == f.readyState) if (200 == f.status) try {
                        var e = JSON.parse(f.responseText);
                        r(i, e)
                    } catch(t) {
                        o(i, t)
                    } else o(i, new Error("XMLHttpRequest response status is " + f.status))
                },
    ...
    function(e, t, i) {
        ...
        function a() {
            function e(t, i) {
                o.find(".weui-picker__group").eq(i).scroll({
                    items: t,
                    temp: a[i],
                    onChange: function(t, r) {
                        t ? s[i] = t.value: s[i] = null,
                        a[i] = r,
                        t.children && t.children.length > 0 ? (o.find(".weui-picker__group").eq(i + 1).show(), e(t.children, i + 1)) : (s[i + 1] = null, s.length = i + 1, o.find(".weui-picker__group").eq(i + 1).hide(), n.onChange(s))
                    },
            ...
            i);
            w[n.id] = w[n.id] || [];
            for (var s = [], a = w[n.id], o = (0, l["default"])(h["default"]), r = d.depthOf(t[0]), c = ""; r--;) c += f["default"];
            return o.find(".weui-picker__bd").html(c),
            y(o),
            e(t, 0),
            o.on("click", ".weui-mask",
            function() {
                b(o)
        ...
        function o(e) {
            ...
            e), i = [], n = [31, 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31], s = t.start; s <= t.end; s++) {
                var o = [];
                s % 4 == 0 && s % 100 != 0 || s % 400 == 0 ? n[1] = 29 : n[1] = 28;
                for (var r = 0; r < 12; r++) {
                    for (var c = [], d = 1; d < n[r] + 1; d++) {
                        var u = {
                            label: d + "日",
                            value: d
                        };
        ...
        y = function(e) {
            m.append(e),
            l["default"].getStyle(e[0], "transform"),
            e.find(".weui-mask").addClass("weui-animate-fade-in"),
            e.find(".weui-picker").addClass("weui-animate-slide-up")
        },
        b = function(e) {
            e.find(".weui-mask").addClass("weui-animate-fade-out"),
            e.find(".weui-picker").addClass("weui-animate-slide-down").on("animationend webkitAnimationEnd",
            function() {
                v(e)
            })
        },
    ...
    function(e, t, i) {
        ...
        l = function(e) {
            for (var t = Math.floor(e.length / 2), i = 0; e[t] && e[t].disabled;) if (t = ++t % e.length, i++, i > e.length) throw new Error("No selectable item.");
            return t
        },
        c = function(e, t, i) {
            var n = l(i);
        ...
        a["default"].fn.scroll = function(e) {
            var t = this,
            i = a["default"].extend({
                items: [],
                ...
                offset: 3,
                rowHeight: 34,
                onChange: a["default"].noop,
                temp: null,
                bodyHeight: 238
            },
            e),
            n = i.items.map(function(e) {
                return '<div class="weui-picker__item' + (e.disabled ? " weui-picker__item_disabled": "") + '">' + e.label + "</div>"
            }).join(""); (0, a["default"])(this).find(".weui-picker__content").html(n);
            var s = (0, a["default"])(this).find(i.scrollable),
            h = void 0,
            p = void 0,
            f = void 0,
            m = void 0,
            ...
            if (null !== i.temp && i.temp < i.items.length) {
                var y = i.temp;
                i.onChange.call(this, i.items[y], y),
                m = (i.offset - y) * i.rowHeight
            } else {
                var b = l(i.items);
                i.onChange.call(this, i.items[b], b),
                m = c(i.offset, i.rowHeight, i.items)
            }
            r(s, m);
            var w = function(e) {
                m += e,
                m = Math.round(m / i.rowHeight) * i.rowHeight;
                var n = d(i.offset, i.rowHeight),
                a = u(i.offset, i.rowHeight, i.items.length);
                m > n && (m = n),
                m < a && (m = a);
                for (var l = i.offset - m / i.rowHeight; i.items[l] && i.items[l].disabled;) e > 0 ? ++l: --l;
                m = (i.offset - l) * i.rowHeight,
                o(s, .3),
                r(s, m),
                i.onChange.call(t, i.items[l], l)
            };
            s = (0, a["default"])(this).offAll().on("touchstart",
            function(e) {
                h = e.changedTouches[0].pageY,
                f = +new Date
            }).on("touchmove",
            function(e) {
            ...
            function(e) {
                ...
                p = e.changedTouches[0].pageY;
                var n = v - i.bodyHeight / 2;
                if (t - f > 100) w(Math.abs(p - h) > 10 ? p - h: n - p);
                else if (Math.abs(p - h) > 10) {
                    for (var s = g.length - 1,
                    a = s,
                    o = s; o > 0 && f - g[o].time < 100; o--) a = o;
                    if (a !== s) {
                        var r = g[s],
                        l = g[a],
                        c = r.time - l.time,
    ...
    function(e, t) {
        ...
        t.depthOf = function i(e) {
            var t = 1;
            return e.children && e.children[0] && (t = i(e.children[0]) + 1),
            t
        }
    },
    function(e, t) {
    ...
    function(e, t, i) {
        ...
        function s(e) {
            function t() {
                n.addClass("weui-animate-fade-out").on("animationend webkitAnimationEnd",
                function() {
                    n.remove(),
                    d = !1
                })
            ...
            return i = o["default"].extend({
                onDelete: o["default"].noop
            },
            i),
            c.append(n),
            n.find(".weui-gallery__img").on("click", t),
            n.find(".weui-gallery__del").on("click",
            function() {
                i.onDelete.call(this, e)
            }),
            n.show().addClass("weui-animate-fade-in"),
            n.hide = t,
            d = n,
            n
        }
...
region.changedDis = function(e, t, i, n) {
    ...
    o = ROOT_URL + "index.php?m=goods&a=in_stock";
...
region.selectRegion = function(e, t, i) {
    return $.get(ROOT_URL + "index.php?m=region&a=select_region_child", {
        raId: e,
        parent: t,
        type: i
    },
...
region.selectDis = function(e, t) {
    $.get(ROOT_URL + "index.php?m=region&a=select_district_list", {
        region_id: e,
        type: t
    },
    function(e) {
...
region.cccDdd = function(e, t, i, n) {
    var s = document.getElementById("province_id").value;
    ROOT_URL + "index.php?m=user&a=addaddress/in_stock";
    if (t <= 0) return ! 1;
    n = 1 == n ? n: "",
    $("#province_id").val(s),
    $("#city_id").val(t),
...
$(function(e) {
    ...
    e(".j-sub-menu").hide(),
    e(".j-get-city-one, .select-two").on("click", "a.j-menu-select",
    function() {
    ...
    e("body").on("click", ".j-get-one .ect-select",
    function() {
    ...
    e(".flow-receipt .r-btn-submit").click(function() {
        ...
        f_r_title && "不开发票" != f_r_cont ? (e.get(ROOT_URL + "index.php?m=flow&a=change_needinv", {
            need_inv: 1,
            inv_type: "",
            inv_payee: f_r_title,
    ...
    e(".flow-coupon .c-btn-submit").click(function() {
        if (e("body").hasClass("show-coupon-div")) {
            ...
            return e.get(ROOT_URL + "index.php?m=flow&a=change_bonus", {
                bonus: t
            },
            function(t) {
                if (t.error) {
    ...
    e(".flow-coupon .cou-btn-submit").click(function() {
        if (e("body").hasClass("show-coupon-div-1")) {
            ...
            return e.get(ROOT_URL + "index.php?m=flow&a=change_coupont", {
                cou_id: t
            },
            function(t) {
                if (t.error) {
    ...
    e(".t-jiantou-gift").click(function() {
        e(".gift-list-box").toggleClass("active"),
        e(".t-jiantou-gift i").toggleClass("active")
    }),
    ...
    e(".text-area1 textarea").bind("input",
    function() {
...
$(function(e) {
    ...
    e(".n-goods-shop-list-nav li").on("click",
    function(t) {
    ...
    e("#province_id").length > 0 && getAddress()
}),
$(function(e) {
    adv_index(),
    e(window).scroll(function() {
    ...
    e(".j-show-div-1").click(function() {
        document.addEventListener("touchmove", handler, !1),
        e(".j-filter-show-div").addClass("show"),
        e(".mask-filter-div").addClass("show")
    }),
    e(".ka-order-btn").click(function() {
        e(this).siblings(".ka-mo").addClass("active"),
        e(".mask-filter-div-box").addClass("active")
    }),
    e(".ma-icon").click(function() {
        e(this).parents(".ka-mo").removeClass("active"),
        e(".mask-filter-div-box").removeClass("active")
    }),
    e(".mask-filter-div-box").click(function() {
        e(".ka-mo").removeClass("active"),
        e(".mask-filter-div-box").removeClass("active")
    }),
    e(".j-goods-guize-box").click(function() {
        e(".goods-show-box,.goods-mn-jiantou .icon-moreunfold").toggleClass("active")
    }),
    e(".j-fengxiang-box").click(function() {
        document.addEventListener("touchmove", handler, !1),
        e(".fengxiang-img-box").addClass("active"),
        e(".fengxing-bg").addClass("active")
    }),
    e(".fengxing-bg").click(function() {
        document.removeEventListener("touchmove", handler, !1),
        e(".fengxiang-img-box").removeClass("active"),
        e(".fengxing-bg").removeClass("active")
    }),
    e(window).scroll(function() {
        e(window).scrollTop() > 100 ? (e(".index-header").addClass("active"), e(".banner-search").addClass("active"), e(".n-input-text").addClass("active"), e(".search-logo").addClass("active"), e(".isxiaoxi1color").addClass("active"), e(".ect-header-banner").addClass("active")) : (e(".banner-search").removeClass("active"), e(".index-header").removeClass("active"), e(".n-input-text").removeClass("active"), e(".search-logo").removeClass("active"), e(".isxiaoxi1color").removeClass("active"), e(".ect-header-banner").removeClass("active")),
        e(window).scrollTop() > 0 ? (e(".store-nav-list").addClass("active"), e(".store-box").addClass("active"), e(".store-box-active").addClass("active")) : (e(".store-nav-list").removeClass("active"), e(".store-box").removeClass("active"), e(".store-box-active").removeClass("active"))
    });
    var t = e(document).scrollTop(),
    i = e(".new-goods-nav").outerHeight();
    e(window).scroll(function() {
        var n = e(document).scrollTop();
        n > i ? e(".new-goods-nav").addClass("goods-bot-active") : e(".new-goods-nav").removeClass("goods-bot-active"),
        n > t ? e(".new-goods-nav").removeClass("goods-top-active") : e(".new-goods-nav").addClass("goods-top-active"),
        t = e(document).scrollTop()
    }),
    e(".commom-nav .left-icon .nav-icon,.common-show").click(function() {
        e(".commom-nav").toggleClass("active"),
        e(".common-show").toggleClass("active"),
        e(".icon-jiantou1").toggleClass("active"),
        e(".filter-top-index").toggleClass("active")
    }),
    e(".j-store-nav-box li").click(function() {
        e(this).addClass("active").siblings().removeClass("active")
    })
});