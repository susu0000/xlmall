...
<section class="index-header ts-2">
    <?php if($app == 'codingyuan') { ?>
    <div class="ect-header-banner dis-box" id="ect-banner">
        <a href="javascript:;"><i class="iconfont icon-guanbi1"></i></a>
        <div class="box-flex">
            <img src="<?php echo elixir('img/more_icon.png');?>" class="fl" />
            <div class="ect-header-text fl">
                <h4>享受更加流畅的商城体验</h4>
                <p>赶快下载多商户APP</p>
            </div>
        </div>
        <a class="btn-submit1" href="http://test.b2b2c.ecjia.com/index.php?m=mobile&c=mobile&a=download">立即下载</a>
    </div>
    <?php } ?>
    <!--search-->
	...
	<section class="dis-box index-new  position-rel">
		...
		<div class="index-new-right">
			<!--<span class="t-jiantou t-remark fr"><a href="<?php echo url('article/index/index');?>">更多<i class="iconfont icon-more f-2"></i></a></span>-->
              <a href="<?php echo url('article/index/index');?>"><div class="index-jt-more" style="color:#444;right:0;padding: 0 1.1rem 0 .7rem;font-size: 1.2rem;">更多</div></a>
		</div>
