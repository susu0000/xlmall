...
class Index extends \app\http\base\controllers\Frontend
{
	...
	public function actionSubmitOrder()
	{
		...
		$order = array('postscript' => htmlspecialchars($_POST['remark']), 'user_id' => $_SESSION['user_id'], 'add_time' => gmtime(), 'order_status' => OS_UNCONFIRMED, 'shipping_status' => SS_UNSHIPPED, 'pay_status' => PS_UNPAYED, 'goods_amount' => $goods_amount, 'order_amount' => $goods_amount, 'referer' => 'touch');
		$error_no = 0;
